import{d as t,c as r,a as l,b as _,h as E}from"./iframe-Dknl-Izy.js";import{a as j}from"./colorShowcase-ukgIxckm.js";import{c as V}from"./createA11yPlay-C_PKokKa.js";import{N as o}from"./NeoCallout-I9iciFMQ.js";import{I as m}from"./defaultIcons-DqG6mseC.js";import{i as z}from"./iconSnippets-DKkOH1Iz.js";import"./preload-helper-Dp1pzeXC.js";import"./axe-Dc5bORdo.js";import"./_plugin-vue_export-helper-DerOYOQE.js";const q=["bordered","filled"],M=_.filter(e=>e!=="white"),oe={title:"Molecules/NeoCallout",component:o,tags:["autodocs"],argTypes:{color:{control:"select",options:M,description:"Theme color. Sets border/background and text color.",table:{category:"Appearance"}},variant:{control:"select",options:q,description:"`bordered` — outline box. `filled` — solid background.",table:{category:"Appearance"}},icon:{control:!1,description:"Optional icon displayed at the start of the callout.",table:{category:"Slots"}},default:{control:!1,description:"Main callout content.",table:{category:"Slots"}}},args:{color:"blue",variant:"bordered"}},s={tags:["snapshot"],render:e=>t({name:"DefaultRender",setup(){return()=>r(o,e,{default:()=>[l("This feature is currently in beta. Behaviour may change in future releases.")]})}}),parameters:{docs:{source:{code:`<NeoCallout color="blue">
