import{d as u,c as n,r as B,F as ae,i as ce}from"./iframe-B0Dukz3x.js";import{p as m}from"./placeholder-CgeahcyT.js";import{N as s}from"./NeoCoverPanelGrid-DzgNUoXK.js";import{N as c}from"./NeoCoverPanel-BmpjssX2.js";import{N as G}from"./NeoPennant-D09rVbDW.js";import"./preload-helper-Dp1pzeXC.js";import"./NeoSection-C1A2UMcz.js";import"./_plugin-vue_export-helper-DerOYOQE.js";import"./NeoImage-DVIlVtyP.js";const se=["small","medium","large"];function l(r){return typeof r=="function"||Object.prototype.toString.call(r)==="[object Object]"&&!ce(r)}const be={title:"Organisms/NeoCoverPanelGrid",component:s,tags:["autodocs"],parameters:{docs:{description:{component:"\nA responsive grid layout for `NeoCoverPanel` items. Uses CSS `auto-fill` with a `minmax` column constraint — the grid drops columns as the container narrows, but never exceeds `columns`.\n\n**How `columns` and `minColumnWidth` interact:**\nThe grid tries to fill as many columns as possible. `minColumnWidth` is the floor — a column will never be narrower than this value. `columns` is the ceiling — the grid will never add more columns than this even when space allows.\n\nSet `minColumnWidth` based on the minimum readable size of your content. Lower values produce more columns at medium widths.\n                "}},controls:{exclude:["color"]}},argTypes:{columns:{control:{type:"select"},options:[2,3,4,5,6],description:"Maximum number of columns at full container width. Works with `minColumnWidth` — see component docs for full explanation.",table:{category:"Layout"}},minColumnWidth:{control:{type:"number",min:80,max:400,step:10},description:"Minimum pixel width each column must be before the grid drops a column. Defaults to `160`.",table:{category:"Layout"}},gap:{control:"select",options:se,description:"Gap between grid items. `small` = `--neo-gap-sm`, `medium` = `--neo-gap-md`, `large` = `--neo-gap-lg`.",table:{category:"Layout"}}},args:{columns:4,minColumnWidth:160,gap:"medium"}},i=["#64748b","#475569","#334155","#6366f1","#8b5cf6","#ec4899","#ef4444","#f97316","#eab308","#22c55e","#06b6d4","#3b82f6"],g=Array.from({length:12},(r,o)=>({imageSrc:m(300,450,i[o%i.length]),imageAlt:`Cover ${o+1}`,title:`Item ${o+1}`,color:"blue"})),de=n("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round","aria-hidden":"true",style:{blockSize:"18px",inlineSize:"18px"}},[n("path",{d:"M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"},null)]),ue=n("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"currentColor","aria-hidden":"true",style:{blockSize:"18px",inlineSize:"18px"}},[n("path",{d:"M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"},null)]),ge=n("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round","aria-hidden":"true",style:{blockSize:"18px",inlineSize:"18px"}},[n("path",{d:"M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"},null)]),pe=n("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"currentColor","aria-hidden":"true",style:{blockSize:"18px",inlineSize:"18px"}},[n("path",{d:"M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"},null)]),A=n("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"currentColor","aria-hidden":"true"},[n("polygon",{points:"12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"},null)]),f={tags:["snapshot"],render:r=>u({name:"DefaultRender",setup(){return()=>{let o;return n(s,r,l(o=g.map(e=>n(c,{key:e.imageSrc,color:e.color,imageSrc:e.imageSrc,imageAlt:e.imageAlt,title:e.title},null)))?o:{default:()=>[o]})}}}),parameters:{docs:{source:{code:`<NeoCoverPanelGrid :columns="4" gap="medium">
  ...
  <NeoCoverPanel
    ...
    :title="item.title"
  />
</NeoCoverPanelGrid>`}}}},y={tags:["snapshot"],args:{section:{fullWidth:!0}},render:r=>u({name:"FullWidthRender",setup(){return()=>{let o;return n(s,r,l(o=g.map(e=>n(c,{key:e.imageSrc,color:e.color,imageSrc:e.imageSrc,imageAlt:e.imageAlt,title:e.title},null)))?o:{default:()=>[o]})}}}),parameters:{docs:{source:{code:`<NeoCoverPanelGrid :columns="4" gap="medium" :section="{fullWidth: true}">
  <NeoCoverPanel
    v-for="item in items"
    :key="item.id"
    :color="item.color"
    ...
    :title="item.title"
  />
</NeoCoverPanelGrid>`}}}},b={tags:["snapshot"],globals:{backgrounds:"#000"},render:r=>u({name:"OnDarkRender",setup(){return()=>{let o;return n("div",{class:"u-onDark",style:{padding:"16px"}},[n(s,r,l(o=g.map(e=>n(c,{key:e.imageSrc,color:e.color,imageSrc:e.imageSrc,imageAlt:e.imageAlt,title:e.title,rounded:!0},null)))?o:{default:()=>[o]})])}}}),parameters:{docs:{source:{code:`<div class="u-onDark">
...
</div>`}}}};var F,W,R;f.parameters={...f.parameters,docs:{...(F=f.parameters)==null?void 0:F.docs,source:{originalSource:`{
  tags: ['snapshot'],
...
}`,...(Y=(X=h.parameters)==null?void 0:X.docs)==null?void 0:Y.source}}};var Z,ee,ne;y.parameters={...y.parameters,docs:{...(Z=y.parameters)==null?void 0:Z.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
    section: {
      fullWidth: true
...
}`,...(re=(te=b.parameters)==null?void 0:te.docs)==null?void 0:re.source}}};const Ae=["Default","TwoColumns","SixColumns","WithPennants","MixedContent","LargeGap","FullWidth","OnDark"];export{f as Default,y as FullWidth,h as LargeGap,C as MixedContent,b as OnDark,S as SixColumns,N as TwoColumns,k as WithPennants,Ae as __namedExportsOrder,be as default};
