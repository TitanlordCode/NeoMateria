import{d as te,c as b,m as ae}from"./iframe-BYCYRk6r.js";import{N as r}from"./NeoSpinner-BU_ZzElv.js";import{N as le}from"./NeoButton-C6H3PoFH.js";import{c as se}from"./colorShowcase-CSIWNWxO.js";import{c as oe}from"./createA11yPlay-B3s8m8FR.js";import"./preload-helper-Dp1pzeXC.js";import"./_plugin-vue_export-helper-DerOYOQE.js";import"./useButton-BV0B7-sX.js";import"./NeoIcon-rF5q0--B.js";import"./axe-zu59xchv.js";const ie=["small","medium","large"],ye={title:"Atoms/NeoSpinner",component:r,tags:["autodocs"],argTypes:{color:{description:"Theme color of the spinning indicator."},size:{control:"select",options:ie,table:{category:"Appearance"},description:"Controls the spinner diameter."},label:{control:"text",table:{category:"Accessibility"},description:"Visible text label rendered alongside the spinner."},ariaLabel:{control:"text",table:{category:"Accessibility"},description:"Screen-reader label when no visible label is shown. Defaults to 'Loading' if omitted."}},args:{size:"medium",color:"blue",ariaLabel:"Loading"},parameters:{snapshot:{viewports:["sm","lg","xl"]}}},o={tags:["snapshot"]},n={tags:["snapshot"],args:{size:"small"}},t={tags:["snapshot"],args:{size:"large"}},l={tags:["snapshot"],args:{label:"Please wait...",dir:"row"}},i={tags:["snapshot"],args:{label:"Please wait..."}},p={tags:["snapshot"]},c={tags:["snapshot"],parameters:{docs:{source:{code:`<NeoButton text="Loading..." color="blue" variant="primary">
  <template #prefix>
