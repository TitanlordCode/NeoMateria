import{d as pe,c as n,a as ue,i as he,m as y}from"./iframe-B-ucO65v.js";import{N as r}from"./NeoIcon-DpSqPmgM.js";import{d as Ie,A as xe,e as s,D as e}from"./defaultIcons-BpMZ8Su5.js";import{c as me}from"./colorShowcase-D_NlCPu3.js";import{c as ge}from"./createA11yPlay-BICAB1NP.js";import"./preload-helper-Dp1pzeXC.js";import"./_plugin-vue_export-helper-DerOYOQE.js";import"./axe-DrnBvHSb.js";function l(o){return typeof o=="function"||Object.prototype.toString.call(o)==="[object Object]"&&!he(o)}const be={title:"Atoms/NeoIcon",component:r,tags:["autodocs"],argTypes:{default:{control:!1,description:"The icon SVG content. Pass a raw SVG element or a Vue component.",table:{category:"Slots"}}},args:{color:"grey",colorVariant:"theme",size:"medium",default:e},render:o=>pe({name:"NeoIconRender",render:()=>n(r,o,{default:()=>[o.default]})}),parameters:{docs:{description:{component:"This is a Wrapper to unify svg Icons with colors and font sizes."}},snapshot:{viewports:["sm","lg","xl"]}}},i={tags:["snapshot"],parameters:{docs:{source:{code:`<NeoIcon color="grey" size="medium">
  ${s}
...
</div>`}}},render:o=>pe({name:"ColorRender",setup(){return()=>n("div",{style:{display:"flex",flexDirection:"column",fontSize:"32px",inlineSize:"fit-content"}},[n("span",null,[ue("With Font size 32px")]),n(r,o,l(e)?e:{default:()=>[e]})])}})},h={tags:["no-test"],args:{color:"green",default:xe},parameters:{docs:{source:{code:`<NeoIcon color="green" size="medium">
  ${Ie}
...
<div style="display: flex; flex-direction: column; font-size: 32px; inline-size: fit-content;">
  ...
  tags: ['!dev', 'test-only'],
  play: createA11yPlay()
}`,...(de=(ie=v.parameters)==null?void 0:ie.docs)==null?void 0:de.source}}};const Ae=["Default","Small","Large","colorVariantTheme","colorVariantText","BigFonts","AddExample","DeleteExample","OnDark","RTL","AllColors","AllColorsOnDark","AllColorsA11y","AllColorsOnDarkA11y"];export{h as AddExample,t as AllColors,f as AllColorsA11y,c as AllColorsOnDark,v as AllColorsOnDarkA11y,u as BigFonts,i as Default,I as DeleteExample,p as Large,x as OnDark,N as RTL,d as Small,Ae as __namedExportsOrder,g as colorVariantText,m as colorVariantTheme,be as default};
