import{d,r as i,c as e,m as y,a as l}from"./iframe-D9nyRK5o.js";import{N as c}from"./NeoSheet-BwumCIPP.js";import{N as a}from"./NeoButton-CODeixOj.js";import{N as F}from"./NeoNavItem-iFyaM9Wl.js";import{N as q}from"./NeoInput-BUHDcCCb.js";import{a as Ye}from"./argTypes-VnJZhiy7.js";import"./preload-helper-Dp1pzeXC.js";import"./_plugin-vue_export-helper-DerOYOQE.js";import"./useButton-B-Bpk_ne.js";import"./NeoIcon-Cexy51PO.js";import"./id-DdmGbVuy.js";const Ke=["left","right","bottom"],Je=["small","medium","large","full"],Xe=["default","filled"],{expect:u,fn:Ze,userEvent:h,waitFor:m,within:M}=__STORYBOOK_MODULE_TEST__,pt={title:"Molecules/NeoSheet",component:c,tags:["autodocs"],parameters:{docs:{description:{component:["Slide-in panel teleported to `<body>` (or a custom `teleportTo` selector) so it always sits above the page.","","**Styling from consumer scoped CSS:** because the sheet content is teleported outside the consumer component's DOM subtree, Vue's `:deep()` selector cannot reach it (the `data-v-*` scope hash never matches). Override sheet internals via the documented `--NeoSheet-*` CSS custom properties on `:root` or on a parent of `<NeoSheet>`, not through scoped CSS."].join(`
