import{d as i,c as o,a as u,b as F,h as w}from"./iframe-BNVHVJhn.js";import{a as k}from"./colorShowcase-BzxvNubM.js";import{N as r}from"./NeoCallout-CKlxriA2.js";import{I as c}from"./defaultIcons-C1WNt4aX.js";import{i as A}from"./iconSnippets-DKkOH1Iz.js";import"./preload-helper-Dp1pzeXC.js";import"./_plugin-vue_export-helper-DerOYOQE.js";const D=["bordered","filled"],R=F.filter(e=>e!=="white"),E={title:"Molecules/NeoCallout",component:r,tags:["autodocs"],argTypes:{color:{control:"select",options:R,description:"Theme color. Sets border/background and text color.",table:{category:"Appearance"}},variant:{control:"select",options:D,description:"`bordered` — outline box. `filled` — solid background.",table:{category:"Appearance"}}},args:{color:"blue",variant:"bordered"}},n={render:e=>i({name:"DefaultRender",setup(){return()=>o(r,e,{default:()=>[u("This feature is currently in beta. Behaviour may change in future releases.")]})}}),parameters:{docs:{source:{code:`<NeoCallout color="blue">
