import{d,r as i,c as e,m as y,a as l}from"./iframe-D97hRsDr.js";import{N as c}from"./NeoSheet-CnRv8Akf.js";import{N as a}from"./NeoButton-e5nE5jrG.js";import{N as F}from"./NeoNavItem-sC9wJFN-.js";import{N as q}from"./NeoInput-BZBdwy8w.js";import{a as Ye}from"./argTypes-VnJZhiy7.js";import"./preload-helper-Dp1pzeXC.js";import"./_plugin-vue_export-helper-DerOYOQE.js";import"./useButton-D7uz1LQ6.js";import"./NeoIcon-9HhtqIbD.js";import"./id-CTCQIiJ9.js";const Ke=["left","right","bottom"],Je=["small","medium","large","full"],Xe=["default","filled"],{expect:u,fn:Ze,userEvent:h,waitFor:m,within:M}=__STORYBOOK_MODULE_TEST__,pt={title:"Molecules/NeoSheet",component:c,tags:["autodocs"],parameters:{docs:{description:{component:["Slide-in panel teleported to `<body>` (or a custom `teleportTo` selector) so it always sits above the page.","","**Styling from consumer scoped CSS:** because the sheet content is teleported outside the consumer component's DOM subtree, Vue's `:deep()` selector cannot reach it (the `data-v-*` scope hash never matches). Override sheet internals via the documented `--NeoSheet-*` CSS custom properties on `:root` or on a parent of `<NeoSheet>`, not through scoped CSS."].join(`
