import{b as A,d as u,c as e}from"./iframe-B4XUuV8F.js";import{N as a}from"./NeoStat-artAdwOL.js";import"./preload-helper-Dp1pzeXC.js";import"./_plugin-vue_export-helper-DerOYOQE.js";const R=["sm","md","lg"],k={title:"Molecules/NeoStat",component:a,tags:["autodocs"],argTypes:{value:{control:"text",table:{category:"Content"}},label:{control:"text",table:{category:"Content"}},color:{control:"select",options:A,description:"Accent color applied to the value.",table:{category:"Appearance"}},size:{control:"select",options:R,description:"Controls the font size of the value and label.",table:{category:"Appearance"}}},args:{value:"12,400",label:"Active users",size:"md"},parameters:{snapshot:{viewports:["sm","md","lg","xl"]}}},r={tags:["snapshot"],render:l=>u({name:"DefaultRender",setup(){return()=>e(a,l,null)}}),parameters:{docs:{source:{code:'<NeoStat value="12,400" label="Active users" />'}}}},o={tags:["snapshot"],args:{color:"blue"},render:l=>u({name:"ColoredRender",setup(){return()=>e(a,l,null)}}),parameters:{docs:{source:{code:'<NeoStat value="12,400" label="Active users" color="blue" />'}}}},n={tags:["no-test"],render:()=>u({name:"AllSizesRender",setup(){return()=>e("div",{style:{display:"flex",gap:"48px",alignItems:"flex-end"}},[e(a,{value:"99k",label:"Small",size:"sm",color:"blue"},null),e(a,{value:"99k",label:"Medium",size:"md",color:"blue"},null),e(a,{value:"99k",label:"Large",size:"lg",color:"blue"},null)])}})},s={tags:["no-test"],render:()=>u({name:"StatRowRender",setup(){const l=[{value:"12,400",label:"Active users",color:"blue"},{value:"98.2%",label:"Uptime",color:"green"},{value:"4.9★",label:"Rating",color:"amber"},{value:"2.1s",label:"Load time",color:"purple"}];return()=>e("div",{style:{display:"flex",gap:"48px",flexWrap:"wrap"}},[l.map(t=>e(a,{key:t.label,value:t.value,label:t.label,color:t.color},null))])}}),parameters:{docs:{source:{code:`<NeoStat value="12,400" label="Active users" color="blue" />
