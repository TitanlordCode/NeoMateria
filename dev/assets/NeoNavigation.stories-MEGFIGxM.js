...
</div>`}}},render:e=>a({name:"OnDarkRender",setup(){return()=>t(n,e,{logo:()=>r(),actions:()=>t(o,{text:"Sign In",color:e.color,size:"medium",variant:"tertiary"},null)})}})},M={tags:["snapshot"],globals:{direction:"rtl"},args:{ariaLabel:"التنقل الرئيسي",menuLabel:"القائمة",closeLabel:"إغلاق"}},d={tags:["snapshot"],parameters:{a11y:{config:{rules:[{id:"landmark-unique",enabled:!1}]}}},render:Te(n,["default"])},g={tags:["snapshot"],globals:{backgrounds:"#000"},parameters:{a11y:{config:{rules:[{id:"landmark-unique",enabled:!1}]}}},render:Te(n,["default"],{dark:!0})},C={...d,tags:["!dev","test-only"],play:Fe()},L={...g,tags:["!dev","test-only"],play:Fe()};var R,P,U;v.parameters={...v.parameters,docs:{...(R=v.parameters)==null?void 0:R.docs,source:{originalSource:`{
  tags: ['snapshot']
