import{u as t,j as e,M as o,T as i}from"./blocks-tc_dsI6A.js";import"./preload-helper-Dp1pzeXC.js";import"./iframe-D97hRsDr.js";function r(s){const n={blockquote:"blockquote",code:"code",h2:"h2",h3:"h3",hr:"hr",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...t(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(o,{title:"Contributing/Project Setup",parameters:{backgrounds:{disable:!0},direction:{disable:!0}}}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Docker"})," — required for snapshot tests (deterministic Linux rendering) and optional for the containerised Storybook dev server"]}),`
`]}),`
`,e.jsx(n.hr,{}),`
`,e.jsx(n.h2,{id:"getting-started",children:"Getting Started"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-bash",children:`npm install
npm run dev          # native Storybook on http://localhost:3000 — fastest on Windows
`})}),`
`,e.jsx(n.p,{children:"If you need the Docker-containerised dev server (matches the snapshot env):"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-bash",children:`npm run dev:docker   # rebuilds the image, then runs Storybook in the container
`})}),`
`,e.jsxs(n.p,{children:["Day-to-day iteration should use ",e.jsx(n.code,{children:"npm run dev"}),". On Windows, bind-mount I/O makes the Docker dev server 50–100× slower than native; only use ",e.jsx(n.code,{children:"dev:docker"})," when you specifically need environment parity with snapshot tests."]}),`
`,e.jsx(n.hr,{}),`
