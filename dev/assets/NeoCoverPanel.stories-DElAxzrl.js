...
</template>`}}},args:{imageSrc:m,imageAlt:"Cover placeholder",clickBehavior:"action",imageAriaLabel:"Select this item",actionAriaLabel:"Add to favorites",actionActive:!1},render:n=>i({name:"ImageClickAndActionButtonRender",setup(){const a=I(!1),t=I(!1);return()=>e("div",{style:{display:"flex",gap:"24px",padding:"16px",alignItems:"flex-start"}},[e("div",{style:{inlineSize:"160px"}},[e(r,l(c(n),{clickBehavior:"action",imageAriaLabel:a.value?"Deselect this item":"Select this item",actionAriaLabel:t.value?"Remove from favorites":"Add to favorites",actionActive:t.value,"onImage-click":()=>{a.value=!a.value},"onAction-click":()=>{t.value=!t.value}}),{"action-icon":({active:L})=>L?d:v})]),e("div",{style:{display:"flex",flexDirection:"column",gap:"8px",fontSize:"14px",fontFamily:"sans-serif",paddingBlockStart:"8px"}},[e("div",null,[H("Image click:")," ",e("strong",{style:{color:a.value?"green":"inherit"}},[a.value?"selected":"idle"])]),e("div",null,[H("Action button:")," ",e("strong",{style:{color:t.value?"#e11d48":"inherit"}},[t.value?"favoured":"idle"])])])])}})},b={tags:["snapshot"],parameters:{docs:{source:{code:`<NeoCoverPanel
  color="blue"
  image-src="/path/to/cover.jpg"
  image-alt="Cover placeholder"
  click-behavior="link"
