import{d as t,c as e,m as J,h as a,a as s}from"./iframe-Bg0OttVg.js";import{N as r}from"./NeoAccordion-HanVie1r.js";import{d as Q,a as X}from"./argTypes-VnJZhiy7.js";import"./preload-helper-Dp1pzeXC.js";import"./_plugin-vue_export-helper-DerOYOQE.js";import"./NeoButton-GRseUT4r.js";import"./useButton-BSwY0W_p.js";import"./NeoIcon-X07-7rWn.js";const Z=["small","medium","large"],$=["default","bordered","filled"],{fn:ee}=__STORYBOOK_MODULE_TEST__,ce={title:"Molecules/NeoAccordion",component:r,tags:["autodocs"],parameters:{controls:{exclude:["color"]},snapshot:{viewports:["sm","md","lg","xl"]}},argTypes:{...X,...Q,title:{control:"text",table:{category:"Content"},description:"Header text shown on the accordion trigger."},size:{control:"select",options:Z,description:"Controls header padding and font size.",table:{category:"Appearance"}},variant:{control:"select",options:$,description:"`default`: no border, transparent background — suitable for use inside other containers. `bordered`: shows a border around the accordion. `filled`: applies a background color to the header.",table:{category:"Appearance"}},defaultExpanded:{control:"boolean",description:"Whether the accordion starts in the open state on mount. Only applied once; not reactive after mount.",table:{category:"State"}}},args:{title:"Click to expand",size:"medium",variant:"default",defaultExpanded:!1,disabled:!1,onToggle:ee()}},o={tags:["snapshot"],parameters:{docs:{source:{code:`<NeoAccordion title="Click to expand">
...
}`,...(b=(w=o.parameters)==null?void 0:w.docs)==null?void 0:b.source}}};var y,N,C;d.parameters={...d.parameters,docs:{...(y=d.parameters)==null?void 0:y.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
...
<NeoAccordion title="Click to expand">
...
}`,...(W=(V=h.parameters)==null?void 0:V.docs)==null?void 0:W.source}}};var M,H,K;g.parameters={...g.parameters,docs:{...(M=g.parameters)==null?void 0:M.docs,source:{originalSource:`{
  tags: ['no-test'],
  parameters: {
    docs: {
      source: {
...
}`,...(K=(H=g.parameters)==null?void 0:H.docs)==null?void 0:K.source}}};var U,Y,q;x.parameters={...x.parameters,docs:{...(U=x.parameters)==null?void 0:U.docs,source:{originalSource:`{
  tags: ['snapshot'],
  globals: {
    backgrounds: '#000'
  },
  ...
  render: Default.render
}`,...(q=(Y=x.parameters)==null?void 0:Y.docs)==null?void 0:q.source}}};const pe=["Default","Expanded","Small","Large","Bordered","Filled","Disabled","CustomIcon","AccordionGroup","OnDark"];export{g as AccordionGroup,l as Bordered,h as CustomIcon,o as Default,m as Disabled,d as Expanded,u as Filled,p as Large,x as OnDark,c as Small,pe as __namedExportsOrder,ce as default};
