import{d as p,c as n,r as I,F as ne,i as ae}from"./iframe-_LwaFV-t.js";import{p as l}from"./placeholder-CgeahcyT.js";import{N as d}from"./NeoCoverPanelGrid-DECXt6bn.js";import{N as s}from"./NeoCoverPanel-BaoB6xcx.js";import{N as w}from"./NeoPennant-T3SPeTD_.js";import"./preload-helper-Dp1pzeXC.js";import"./_plugin-vue_export-helper-DerOYOQE.js";import"./NeoImage-D2JyCSBo.js";const ie=["small","medium","large"];function m(r){return typeof r=="function"||Object.prototype.toString.call(r)==="[object Object]"&&!ae(r)}const fe={title:"Organisms/NeoCoverPanelGrid",component:d,tags:["autodocs"],parameters:{docs:{description:{component:"\nA responsive grid layout for `NeoCoverPanel` items. Uses CSS `auto-fill` with a `minmax` column constraint — the grid drops columns as the container narrows, but never exceeds `columns`.\n\n**How `columns` and `minColumnWidth` interact:**\nThe grid tries to fill as many columns as possible. `minColumnWidth` is the floor — a column will never be narrower than this value. `columns` is the ceiling — the grid will never add more columns than this even when space allows.\n\nSet `minColumnWidth` based on the minimum readable size of your content. Lower values produce more columns at medium widths.\n                "}},controls:{exclude:["color"]}},argTypes:{columns:{control:{type:"select"},options:[2,3,4,5,6],description:"Maximum number of columns at full container width. Works with `minColumnWidth` — see component docs for full explanation.",table:{category:"Layout"}},minColumnWidth:{control:{type:"number",min:80,max:400,step:10},description:"Minimum pixel width each column must be before the grid drops a column. Defaults to `160`.",table:{category:"Layout"}},gap:{control:"select",options:ie,description:"Gap between grid items. `small` = `--neo-gap-sm`, `medium` = `--neo-gap-md`, `large` = `--neo-gap-lg`.",table:{category:"Layout"}}},args:{columns:4,minColumnWidth:160,gap:"medium"}},i=["#64748b","#475569","#334155","#6366f1","#8b5cf6","#ec4899","#ef4444","#f97316","#eab308","#22c55e","#06b6d4","#3b82f6"],u=Array.from({length:12},(r,t)=>({imageSrc:l(300,450,i[t%i.length]),imageAlt:`Cover ${t+1}`,title:`Item ${t+1}`,color:"blue"})),le=n("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round","aria-hidden":"true",style:{blockSize:"18px",inlineSize:"18px"}},[n("path",{d:"M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"},null)]),me=n("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"currentColor","aria-hidden":"true",style:{blockSize:"18px",inlineSize:"18px"}},[n("path",{d:"M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"},null)]),ce=n("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round","aria-hidden":"true",style:{blockSize:"18px",inlineSize:"18px"}},[n("path",{d:"M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"},null)]),se=n("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"currentColor","aria-hidden":"true",style:{blockSize:"18px",inlineSize:"18px"}},[n("path",{d:"M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"},null)]),b=n("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"currentColor","aria-hidden":"true"},[n("polygon",{points:"12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"},null)]),f={tags:["snapshot"],render:r=>p({name:"DefaultRender",setup(){return()=>{let t;return n("div",{style:{padding:"16px"}},[n(d,r,m(t=u.map(e=>n(s,{key:e.imageSrc,color:e.color,imageSrc:e.imageSrc,imageAlt:e.imageAlt,title:e.title},null)))?t:{default:()=>[t]})])}}}),parameters:{docs:{source:{code:`<NeoCoverPanelGrid :columns="4" gap="medium">
  <NeoCoverPanel
    ...
    :title="item.title"
  />
</NeoCoverPanelGrid>`}}}},N={tags:["snapshot"],args:{columns:2},render:r=>p({name:"TwoColumnsRender",setup(){return()=>{let t;return n("div",{style:{padding:"16px"}},[n(d,r,m(t=u.slice(0,6).map(e=>n(s,{key:e.imageSrc,color:e.color,imageSrc:e.imageSrc,imageAlt:e.imageAlt,title:e.title},null)))?t:{default:()=>[t]})])}}}),parameters:{docs:{source:{code:`<NeoCoverPanelGrid :columns="2" gap="medium">
  <NeoCoverPanel
    v-for="item in items"
    :key="item.id"
    :color="item.color"
    ...
    :title="item.title"
  />
</NeoCoverPanelGrid>`}}}},S={tags:["snapshot"],args:{columns:6,minColumnWidth:120},render:r=>p({name:"SixColumnsRender",setup(){return()=>{let t;return n("div",{style:{padding:"16px"}},[n(d,r,m(t=u.map(e=>n(s,{key:e.imageSrc,color:e.color,imageSrc:e.imageSrc,imageAlt:e.imageAlt,title:e.title,rounded:!0},null)))?t:{default:()=>[t]})])}}}),parameters:{docs:{source:{code:`<NeoCoverPanelGrid :columns="6" :min-column-width="120" gap="medium">
  <NeoCoverPanel
    v-for="item in items"
    :key="item.id"
    :color="item.color"
    ...
    rounded
  />
</NeoCoverPanelGrid>`}}}},k={tags:["snapshot"],render:r=>{const t=[{rank:"yellow",platform:"blue"},{rank:"yellow",platform:"blueGrey"},{rank:"yellow",platform:"purple"},{rank:"grey",platform:"red"},{rank:"grey",platform:"blue"},{rank:"grey",platform:"green"},{rank:"grey",platform:"blueGrey"},{rank:"grey",platform:"purple"}];return p({name:"WithPennantsRender",setup(){return()=>{let e;return n("div",{style:{padding:"16px"}},[n(d,r,m(e=u.slice(0,8).map((c,v)=>n(s,{key:c.imageSrc,color:"blue",imageSrc:c.imageSrc,imageAlt:c.imageAlt,title:c.title,rounded:!0},{pennants:()=>n(ne,null,[n(w,{color:t[v].platform},m(b)?b:{default:()=>[b]}),n(w,{color:t[v].rank},{default:()=>[v+1]})])})))?e:{default:()=>[e]})])}}})},parameters:{docs:{source:{code:`<NeoCoverPanelGrid :columns="4" gap="medium">
  <NeoCoverPanel
...
</NeoCoverPanelGrid>`}}}},h={tags:["no-test"],args:{gap:"large"},render:r=>p({name:"LargeGapRender",setup(){return()=>{let t;return n("div",{style:{padding:"16px"}},[n(d,r,m(t=u.slice(0,8).map(e=>n(s,{key:e.imageSrc,color:e.color,imageSrc:e.imageSrc,imageAlt:e.imageAlt,title:e.title},null)))?t:{default:()=>[t]})])}}}),parameters:{docs:{source:{code:`<NeoCoverPanelGrid :columns="4" gap="large">
  <NeoCoverPanel
    v-for="item in items"
    :key="item.id"
    :color="item.color"
    ...
    :title="item.title"
  />
</NeoCoverPanelGrid>`}}}},y={tags:["snapshot"],globals:{backgrounds:"#000"},render:r=>p({name:"OnDarkRender",setup(){return()=>{let t;return n("div",{class:"u-onDark",style:{padding:"16px"}},[n(d,r,m(t=u.map(e=>n(s,{key:e.imageSrc,color:e.color,imageSrc:e.imageSrc,imageAlt:e.imageAlt,title:e.title,rounded:!0},null)))?t:{default:()=>[t]})])}}}),parameters:{docs:{source:{code:`<div class="u-onDark">
...
This story combines all optional props to show the full range of panel content.`,...(J=(q=C.parameters)==null?void 0:q.docs)==null?void 0:J.description}}};var K,Q,X;h.parameters={...h.parameters,docs:{...(K=h.parameters)==null?void 0:K.docs,source:{originalSource:`{
  tags: ['no-test'],
  args: {
    gap: 'large'
  },
...
}`,...(ee=(Z=y.parameters)==null?void 0:Z.docs)==null?void 0:ee.source}}};const Ne=["Default","TwoColumns","SixColumns","WithPennants","MixedContent","LargeGap","OnDark"];export{f as Default,h as LargeGap,C as MixedContent,y as OnDark,S as SixColumns,N as TwoColumns,k as WithPennants,Ne as __namedExportsOrder,fe as default};
