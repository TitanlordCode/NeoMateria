import{d as u,c as r,F as d,b as T,h as O}from"./iframe-_LwaFV-t.js";import{p as j}from"./placeholder-CgeahcyT.js";import{a as E}from"./colorShowcase-mTvG6tuw.js";import{c as F}from"./createA11yPlay-k-ODbeDd.js";import{N as t}from"./NeoHero-B_KgB3rn.js";import{a as I}from"./NeoHeadlineTypes-CVOcXnNm.js";import{N as p}from"./NeoButton-DcNGoYOB.js";import{N as m}from"./NeoLinkButton-BILkN0r_.js";import{N as M}from"./NeoImage-D2JyCSBo.js";import"./preload-helper-Dp1pzeXC.js";import"./axe-Ue4VX9fj.js";import"./_plugin-vue_export-helper-DerOYOQE.js";import"./NeoHeadlinePrimary-CzMnbp_A.js";import"./useHeadline-C3m15hx5.js";import"./useButton-CEg444c1.js";import"./NeoIcon-BBZo5uSS.js";const _=["centered","split"],$=["sm","md","lg"],q=T.filter(e=>e!=="white"),ce={title:"Organisms/NeoHero",component:t,tags:["autodocs"],argTypes:{title:{control:"text",table:{category:"Content"}},subtitle:{control:"text",table:{category:"Content"}},variant:{control:"select",options:_,description:"`centered` — stacked, text centered. `split` — text left, media right.",table:{category:"Appearance"}},size:{control:"select",options:$,description:"Controls vertical padding.",table:{category:"Appearance"}},headingTag:{control:"select",options:I,description:"HTML element for the heading. Defaults to `h1` — change only for non-page-level heroes.",table:{category:"Appearance"}},color:{control:"select",options:q,description:"Accent color applied to the title.",table:{category:"Appearance"}},actions:{control:!1,description:"CTA buttons or interactive elements rendered below the headline and body copy.",table:{category:"Slots"}},media:{control:!1,description:"Media content (image, video) displayed beside the text in `split` variant.",table:{category:"Slots"}}},args:{title:"Build beautiful interfaces",subtitle:"A complete Vue 3 design system — accessible, themed, and ready for production.",variant:"centered",size:"md",color:"blue"}},n={tags:["snapshot"],render:e=>u({name:"CenteredRender",setup(){return()=>r(t,e,{actions:()=>r(d,null,[r(p,{text:"Get started",color:e.color??"blue",variant:"primary"},null),r(m,{href:"#",text:"View docs",color:e.color??"blue",variant:"secondary"},null)])})}}),parameters:{docs:{source:{code:`<NeoHero
