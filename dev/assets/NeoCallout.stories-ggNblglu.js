import{d as t,c as o,a as s,b as _,h as E}from"./iframe-C76Gz-Ft.js";import{a as j}from"./colorShowcase-Cry6E5QG.js";import{c as V}from"./createA11yPlay-B-wpq2rx.js";import{N as r}from"./NeoCallout-DSQP9dDD.js";import{I as m}from"./defaultIcons-Dky2e0vO.js";import{i as z}from"./iconStrings-DsK5_d8D.js";import"./preload-helper-Dp1pzeXC.js";import"./axe-Caaruy_c.js";import"./_plugin-vue_export-helper-DerOYOQE.js";const q=["bordered","filled"],M=_.filter(e=>e!=="white"),re={title:"Molecules/NeoCallout",component:r,tags:["autodocs"],argTypes:{color:{control:"select",options:M,description:"Theme color. Sets border/background and text color.",table:{category:"Appearance"}},variant:{control:"select",options:q,description:"`bordered` — outline box. `filled` — solid background.",table:{category:"Appearance"}},icon:{control:!1,description:"Optional icon displayed at the start of the callout.",table:{category:"Slots"}},default:{control:!1,description:"Main callout content.",table:{category:"Slots"}}},args:{color:"blue",variant:"bordered"},parameters:{snapshot:{viewports:["sm","md","lg","xl"]}}},l={tags:["snapshot"],render:e=>t({name:"DefaultRender",setup(){return()=>o(r,e,{default:()=>[s("This feature is currently in beta. Behaviour may change in future releases.")]})}}),parameters:{docs:{source:{code:`<NeoCallout color="blue">
