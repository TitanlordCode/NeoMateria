...
</NeoButton>`}}},render:e=>D({name:"LoadingRender",setup(){return()=>t(r,e,{prefix:()=>t(qe,{size:"small",color:e.color,ariaHidden:!0},null)})}})},k={tags:["!dev"],render:()=>D({name:"InteractionRender",setup(){const e=$e(!1);return()=>t(r,{color:"blue",variant:"primary",onClick:()=>{e.value=!0}},{default:()=>[e.value?"Clicked!":"Click me"]})}}),play:async({canvasElement:e,step:Ze})=>{const E=lt(e);await Ze("Click fires and updates component state",async()=>{await it.click(E.getByRole("button",{name:"Click me"})),await ot(E.getByRole("button")).toHaveTextContent("Clicked!")})}},C={tags:["snapshot"],globals:{backgrounds:"#000"},parameters:{snapshot:{viewports:["sm","xl"]}}},A={tags:["snapshot"],globals:{direction:"rtl"},args:{text:"انقر هنا"},parameters:{snapshot:{viewports:["sm","xl"]}}},a={tags:["snapshot"],parameters:{snapshot:{viewports:["sm","xl"]}},render:Qe(r,["primary","secondary","tertiary","ghost"])},s={tags:["snapshot"],globals:{backgrounds:"#000"},parameters:{snapshot:{viewports:["sm","xl"]}},render:Qe(r,["primary","secondary","tertiary","ghost"],{dark:!0})},B={...a,tags:["!dev","test-only"],play:Xe()},N={...s,tags:["!dev","test-only"],play:Xe()};var I,W,R;n.parameters={...n.parameters,docs:{...(I=n.parameters)==null?void 0:I.docs,source:{originalSource:`{
  tags: ['snapshot']
}`,...(R=(W=n.parameters)==null?void 0:W.docs)==null?void 0:R.source}}};var z,T,O;o.parameters={...o.parameters,docs:{...(z=o.parameters)==null?void 0:z.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
    size: 'small'
  }
}`,...(O=(T=o.parameters)==null?void 0:T.docs)==null?void 0:O.source}}};var P,L,G;c.parameters={...c.parameters,docs:{...(P=c.parameters)==null?void 0:P.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
    size: 'large'
  }
...
}`,...(re=(te=m.parameters)==null?void 0:te.docs)==null?void 0:re.source}}};var ae,se,ne;g.parameters={...g.parameters,docs:{...(ae=g.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
    variant: 'ghost',
...
}`,...(ne=(se=g.parameters)==null?void 0:se.docs)==null?void 0:ne.source}}};var oe,ce,ie;h.parameters={...h.parameters,docs:{...(oe=h.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
