import{u as s,j as e,M as o,T as t}from"./blocks-DTDJ2_t2.js";import"./preload-helper-Dp1pzeXC.js";import"./iframe-Da9xFhCi.js";function r(i){const n={blockquote:"blockquote",code:"code",h2:"h2",h3:"h3",hr:"hr",p:"p",pre:"pre",strong:"strong",...s(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(o,{title:"Foundation/Typography",parameters:{backgrounds:{disable:!0},direction:{disable:!0}}}),`
...
`,e.jsx("div",{style:{padding:"16px"},children:e.jsx("div",{style:{border:"1px solid var(--docs-color-border)",borderRadius:"8px",display:"flex",flexDirection:"column",gap:"4px",inlineSize:"220px",padding:"8px"},children:["Short label","A slightly longer navigation label","An extremely long navigation label that would normally wrap onto a second line"].map(l=>e.jsx("div",{style:{borderRadius:"6px",color:"var(--docs-color-text-label)",fontSize:"0.875rem",overflow:"hidden",padding:"6px 10px",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:l},l))})}),`
`,e.jsx(n.hr,{}),`
...
`,e.jsx("div",{style:{display:"grid",gap:"24px",gridTemplateColumns:"repeat(auto-fill, minmax(240px, 1fr))",padding:"16px"},children:[{label:"Long URL in title — wraps without overflow",title:"https://very-long-url-example.com/path/to/some/deeply/nested/resource?with=query&params=here",description:"Description stays readable below."},{label:"Long translation key — breaks at word boundary",title:"TRANSLATION_KEY_COMPONENT_SECTION_SUBSECTION_ELEMENT_STATE_VARIANT",description:"Useful when keys are shown in development or error states."}].map(l=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"8px"},children:[e.jsx("p",{style:{color:"var(--docs-color-text-secondary)",fontSize:"0.75rem",margin:"0"},children:l.label}),e.jsxs("div",{style:{border:"1px solid var(--docs-color-border)",borderRadius:"8px",overflow:"hidden"},children:[e.jsx("div",{style:{background:"var(--neo-color-blue100)",blockSize:"80px"}}),e.jsxs("div",{style:{padding:"12px"},children:[e.jsx("p",{style:{fontWeight:"600",lineHeight:"1.3",margin:"0 0 6px",overflowWrap:"break-word"},children:l.title}),e.jsx("p",{style:{color:"var(--docs-color-text-secondary)",fontSize:"0.875rem",lineHeight:"1.5",margin:"0"},children:l.description})]})]})]},l.label))}),`
`,e.jsx(n.hr,{}),`
