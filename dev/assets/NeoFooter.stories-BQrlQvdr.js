import{d as L,c as e,a as o,F as N}from"./iframe-B0Dukz3x.js";import{N as n}from"./NeoFooter-Ci8kZAFt.js";import{N as r}from"./NeoLink-BbSGyNJ6.js";import{a as de}from"./argTypes-VnJZhiy7.js";import{c as ce}from"./colorShowcase-DrQqXaLn.js";import{c as me}from"./createA11yPlay-BQ9rYRTW.js";import"./preload-helper-Dp1pzeXC.js";import"./_plugin-vue_export-helper-DerOYOQE.js";import"./NeoLinkGroup-Dht5wBfR.js";import"./NeoHeadlineQuaternary-CSVw15ie.js";import"./useHeadline-DgrZFlcf.js";import"./axe-C0a-FzRY.js";const ue=["simple","multi-column","centered"],pe=[{title:"Product",links:[{text:"Features",href:"#features"},{text:"Pricing",href:"#pricing"},{text:"Documentation",href:"#docs"},{text:"Changelog",href:"#changelog"}]},{title:"Company",links:[{text:"About Us",href:"#about"},{text:"Blog",href:"#blog"},{text:"Careers",href:"#careers"},{text:"Contact",href:"#contact"}]},{title:"Resources",links:[{text:"Community",href:"#community"},{text:"Support",href:"#support"},{text:"API Reference",href:"#api"},{text:"Tutorials",href:"#tutorials"}]},{title:"Legal",links:[{text:"Privacy Policy",href:"#privacy"},{text:"Terms of Service",href:"#terms"},{text:"Cookie Policy",href:"#cookies"}]}],Se={title:"Organisms/NeoFooter",component:n,tags:["autodocs"],argTypes:{...de,color:{description:"Theme color for link hover/active states and accents.",table:{category:"Appearance"}},sections:{control:!1,description:"Array of link-group sections. Each section: `{ title: string, links: Array<{ text, href, external? }> }`.",table:{category:"Content"}},copyrightText:{control:"text",description:"Copyright line rendered at the bottom of the footer.",table:{category:"Content"}},layout:{control:"select",options:ue,description:"`multi-column`: sections displayed in a responsive grid. `simple`: single-row layout with sections collapsed. `centered`: all content centred horizontally.",table:{category:"Appearance"}},logo:{control:!1,description:"Brand logo displayed in the footer header area.",table:{category:"Slots"}},social:{control:!1,description:"Social media icons or links.",table:{category:"Slots"}},legal:{control:!1,description:"Legal links or text rendered at the bottom of the footer.",table:{category:"Slots"}}},args:{color:"blue",layout:"multi-column",sections:pe,copyrightText:"© 2026 NeoMateria. All rights reserved."}},a={tags:["snapshot"]},l={tags:["snapshot"],args:{layout:"simple"}},c={tags:["snapshot"],args:{layout:"centered"}},m={tags:["snapshot"],parameters:{docs:{source:{code:`<NeoFooter color="blue" :sections="sections" copyright-text="© 2026 NeoMateria.">
  <template #logo>
...
</NeoFooter>`}}},render:t=>L({name:"WithLegalLinksRender",setup(){return()=>e(n,t,{legal:()=>e(N,null,[e(r,{href:"#privacy",color:"grey",size:"small"},{default:()=>[o("Privacy")]}),e(r,{href:"#terms",color:"grey",size:"small"},{default:()=>[o("Terms")]}),e(r,{href:"#cookies",color:"grey",size:"small"},{default:()=>[o("Cookies")]})])})}})},p={tags:["snapshot"],parameters:{docs:{source:{code:`<NeoFooter color="blue" :sections="sections" copyright-text="© 2026 NeoMateria.">
  <template #logo>
    <div style="font-size: 24px; font-weight: bold; color: var(--neo-theme-color);">
      NeoMateria
    </div>
...
</NeoFooter>`}}},render:t=>L({name:"CompleteRender",setup(){return()=>e(n,t,{logo:()=>e("div",{style:{fontSize:"24px",fontWeight:"bold",color:"var(--neo-theme-color)"}},[o("NeoMateria")]),social:()=>e(N,null,[e(r,{href:"#twitter",color:"blue",size:"medium"},{default:()=>[o("Twitter")]}),e(r,{href:"#github",color:"grey",size:"medium"},{default:()=>[o("GitHub")]}),e(r,{href:"#discord",color:"indigo",size:"medium"},{default:()=>[o("Discord")]}),e(r,{href:"#linkedin",color:"blue",size:"medium"},{default:()=>[o("LinkedIn")]})]),legal:()=>e(N,null,[e(r,{href:"#privacy",color:"grey",size:"small"},{default:()=>[o("Privacy Policy")]}),e(r,{href:"#terms",color:"grey",size:"small"},{default:()=>[o("Terms of Service")]}),e(r,{href:"#cookies",color:"grey",size:"small"},{default:()=>[o("Cookie Policy")]})])})}})},g={tags:["snapshot"],args:{sections:[],layout:"centered"}},h={tags:["snapshot"],globals:{backgrounds:"#000"}},f={tags:["snapshot"],globals:{direction:"rtl"},args:{copyrightText:"© 2026 نيوماتيريا. جميع الحقوق محفوظة."}},s={tags:["snapshot"],parameters:{a11y:{config:{rules:[{id:"landmark-no-duplicate-contentinfo",enabled:!1},{id:"landmark-unique",enabled:!1}]}}},render:ce(n,["multi-column"])},i={tags:["snapshot"],globals:{backgrounds:"#000"},parameters:{a11y:{config:{rules:[{id:"landmark-no-duplicate-contentinfo",enabled:!1},{id:"landmark-unique",enabled:!1}]}}},render:ce(n,["multi-column"],{dark:!0})},k={...s,tags:["!dev","test-only"],play:me()},y={...i,tags:["!dev","test-only"],play:me()};var b,z,v;a.parameters={...a.parameters,docs:{...(b=a.parameters)==null?void 0:b.docs,source:{originalSource:`{
  tags: ['snapshot']
}`,...(v=(z=a.parameters)==null?void 0:z.docs)==null?void 0:v.source}}};var x,C,S;l.parameters={...l.parameters,docs:{...(x=l.parameters)==null?void 0:x.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
    layout: 'simple'
  }
}`,...(S=(C=l.parameters)==null?void 0:C.docs)==null?void 0:S.source}}};var A,F,P;c.parameters={...c.parameters,docs:{...(A=c.parameters)==null?void 0:A.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
    layout: 'centered'
  }
}`,...(P=(F=c.parameters)==null?void 0:F.docs)==null?void 0:P.source}}};var T,w,D;m.parameters={...m.parameters,docs:{...(T=m.parameters)==null?void 0:T.docs,source:{originalSource:`{
  tags: ['snapshot'],
  parameters: {
    docs: {
      source: {
...
}`,...(D=(w=m.parameters)==null?void 0:w.docs)==null?void 0:D.source}}};var M,W,R;d.parameters={...d.parameters,docs:{...(M=d.parameters)==null?void 0:M.docs,source:{originalSource:`{
  tags: ['snapshot'],
  parameters: {
    docs: {
      source: {
...
}`,...(R=(W=d.parameters)==null?void 0:W.docs)==null?void 0:R.source}}};var O,G,H;u.parameters={...u.parameters,docs:{...(O=u.parameters)==null?void 0:O.docs,source:{originalSource:`{
  tags: ['snapshot'],
  parameters: {
    docs: {
      source: {
...
}`,...(H=(G=u.parameters)==null?void 0:G.docs)==null?void 0:H.source}}};var I,q,B;p.parameters={...p.parameters,docs:{...(I=p.parameters)==null?void 0:I.docs,source:{originalSource:`{
  tags: ['snapshot'],
  parameters: {
    docs: {
      source: {
...
}`,...(B=(q=p.parameters)==null?void 0:q.docs)==null?void 0:B.source}}};var E,V,_;g.parameters={...g.parameters,docs:{...(E=g.parameters)==null?void 0:E.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
    sections: [],
    layout: 'centered'
