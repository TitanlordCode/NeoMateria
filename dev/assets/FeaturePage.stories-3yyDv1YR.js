...
<template>
  ...
  />
</template>`,a={args:{color:"blue"},parameters:{docs:{source:{code:c("blue")}}},render:e=>o({name:"DefaultStoryRender",setup(){return()=>t(s,{color:e.color},null)}})},n={args:{color:"green"},parameters:{docs:{source:{code:c("green")}}},render:e=>o({name:"GreenStoryRender",setup(){return()=>t(s,{color:e.color},null)}})},i={args:{color:"purple"},parameters:{docs:{source:{code:c("purple")}}},render:e=>o({name:"PurpleStoryRender",setup(){return()=>t(s,{color:e.color},null)}})},l={args:{color:"blue"},globals:{backgrounds:"#000"},parameters:{docs:{source:{code:c("blue")}}},render:e=>o({name:"DarkModeStoryRender",setup(){return()=>t(s,{color:e.color,dark:!0},null)}})};var g,f,h;a.parameters={...a.parameters,docs:{...(g=a.parameters)==null?void 0:g.docs,source:{originalSource:`{
  args: {
    color: 'blue'
  },
  parameters: {
...
}`,...(F=(C=l.parameters)==null?void 0:C.docs)==null?void 0:F.source}}};const me=["Default","Green","Purple","DarkMode"];export{l as DarkMode,a as Default,n as Green,i as Purple,me as __namedExportsOrder,de as default};
