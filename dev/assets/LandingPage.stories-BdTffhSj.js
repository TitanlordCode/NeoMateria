...
</template>`,n={args:{color:"blue"},parameters:{docs:{source:{code:m("blue")}}},render:e=>r({name:"DefaultStoryRender",setup(){return()=>t(c,{color:e.color},null)}})},i={args:{color:"green"},parameters:{docs:{source:{code:m("green")}}},render:e=>r({name:"GreenStoryRender",setup(){return()=>t(c,{color:e.color},null)}})},l={args:{color:"purple"},parameters:{docs:{source:{code:m("purple")}}},render:e=>r({name:"PurpleStoryRender",setup(){return()=>t(c,{color:e.color},null)}})},s={args:{color:"blue"},globals:{backgrounds:"#000"},parameters:{docs:{source:{code:j}}},render:e=>r({name:"DarkModeStoryRender",setup(){return()=>t(c,{color:e.color,dark:!0},null)}})};var g,y,f;n.parameters={...n.parameters,docs:{...(g=n.parameters)==null?void 0:g.docs,source:{originalSource:`{
  args: {
    color: 'blue'
  },
  parameters: {
...
}`,...(A=(C=s.parameters)==null?void 0:C.docs)==null?void 0:A.source}}};const be=["Default","Green","Purple","DarkMode"];export{s as DarkMode,n as Default,i as Green,l as Purple,be as __namedExportsOrder,he as default};
