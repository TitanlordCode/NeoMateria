import{d as te,c as b,m as ae}from"./iframe-Bg0OttVg.js";import{N as r}from"./NeoSpinner-C23fDPC6.js";import{N as le}from"./NeoButton-GRseUT4r.js";import{c as se}from"./colorShowcase-BQraTlZf.js";import{c as oe}from"./createA11yPlay-DxivIEqv.js";import"./preload-helper-Dp1pzeXC.js";import"./_plugin-vue_export-helper-DerOYOQE.js";import"./useButton-BSwY0W_p.js";import"./NeoIcon-X07-7rWn.js";import"./axe-CjNTfdGc.js";const ie=["small","medium","large"],fe={title:"Atoms/NeoSpinner",component:r,tags:["autodocs"],argTypes:{color:{description:"Theme color of the spinning indicator."},size:{control:"select",options:ie,table:{category:"Appearance"},description:"Controls the spinner diameter."},label:{control:"text",table:{category:"Accessibility"},description:"Visible text label rendered alongside the spinner."},ariaLabel:{control:"text",table:{category:"Accessibility"},description:"Screen-reader label when no visible label is shown. Defaults to 'Loading' if omitted."},ariaHidden:{control:"boolean",table:{category:"Accessibility"},description:"Hides the spinner from assistive tech. Use when a surrounding region already announces loading."},dir:{control:"select",options:["column","row"],table:{category:"Layout"},description:"Stacks the spinner and label vertically (`column`) or inline (`row`)."}},args:{size:"medium",color:"blue",ariaLabel:"Loading"},parameters:{snapshot:{viewports:["sm","lg","xl"]}}},o={tags:["snapshot"]},n={tags:["snapshot"],args:{size:"small"}},t={tags:["snapshot"],args:{size:"large"}},l={tags:["snapshot"],args:{label:"Please wait...",dir:"row"}},i={tags:["snapshot"],args:{label:"Please wait..."}},c={tags:["snapshot"]},p={tags:["snapshot"],parameters:{docs:{source:{code:`<NeoButton text="Loading..." color="blue" variant="primary">
  <template #prefix>
