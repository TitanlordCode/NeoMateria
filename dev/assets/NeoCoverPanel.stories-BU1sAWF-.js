...
</template>`}}},args:{imageSrc:m,imageAlt:"Cover placeholder",clickBehavior:"action",imageAriaLabel:"Select this item",actionAriaLabel:"Add to favorites",actionActive:!1},render:n=>i({name:"ImageClickAndActionButtonRender",setup(){const a=I(!1),t=I(!1);return()=>e("div",{style:{display:"flex",gap:"24px",padding:"16px",alignItems:"flex-start"}},[e("div",{style:{inlineSize:"160px"}},[e(r,l(c(n),{clickBehavior:"action",imageAriaLabel:a.value?"Deselect this item":"Select this item",actionAriaLabel:t.value?"Remove from favorites":"Add to favorites",actionActive:t.value,"onImage-click":()=>{a.value=!a.value},"onAction-click":()=>{t.value=!t.value}}),{"action-icon":({active:B})=>B?p:v})]),e("div",{style:{display:"flex",flexDirection:"column",gap:"8px",fontSize:"14px",fontFamily:"sans-serif",paddingBlockStart:"8px"}},[e("div",null,[R("Image click:")," ",e("strong",{style:{color:a.value?"green":"inherit"}},[a.value?"selected":"idle"])]),e("div",null,[R("Action button:")," ",e("strong",{style:{color:t.value?"#e11d48":"inherit"}},[t.value?"favoured":"idle"])])])])}})},b={tags:["snapshot"],parameters:{docs:{source:{code:`<NeoCoverPanel
  color="blue"
  image-src="/path/to/cover.jpg"
  image-alt="Cover placeholder"
  click-behavior="link"
...
</NeoCoverPanel>`}}},args:{imageSrc:m,imageAlt:"Cover placeholder"},render:n=>i({name:"WithManyPennantsRender",setup(){return()=>e("div",{style:{inlineSize:"160px",padding:"16px"}},[e(r,l(c(n),{clickBehavior:"none"}),{pennants:()=>e(Pe,null,[e(s,{color:"yellow"},d(o)?o:{default:()=>[o]}),e(s,{color:"blue"},d(o)?o:{default:()=>[o]}),e(s,{color:"green"},d(o)?o:{default:()=>[o]}),e(s,{color:"purple"},d(o)?o:{default:()=>[o]}),e(s,{color:"red"},d(o)?o:{default:()=>[o]})])})])}})},C={tags:["snapshot"],parameters:{docs:{source:{code:`<NeoCoverPanel
  color="blue"
  image-src="/path/to/cover.jpg"
  image-alt="Cover placeholder"
  click-behavior="none"
...
</NeoCoverPanel>`}}},args:{imageSrc:m,imageAlt:"Cover placeholder",actionAriaLabel:"Remove from favorites",actionActive:!0},render:n=>i({name:"ActionActiveRender",setup(){return()=>e("div",{style:{inlineSize:"160px",padding:"16px"}},[e(r,l(c(n),{clickBehavior:"none",actionAriaLabel:"Remove from favorites",actionActive:!0}),{"action-icon":({active:a})=>a?p:v})])}})},y={tags:["snapshot"],parameters:{docs:{source:{code:`<script setup>
import { ref } from 'vue'
...
</template>`}}},args:{imageSrc:m,imageAlt:"Cover placeholder",actionAriaLabel:"42 votes"},render:n=>i({name:"WithActionCountRender",setup(){const a=I(42),t=I(!1),B=()=>{t.value=!t.value,a.value=t.value?a.value+1:a.value-1};return()=>e("div",{style:{inlineSize:"160px",padding:"16px"}},[e(r,l(c(n),{clickBehavior:"none",actionAriaLabel:`${a.value} votes`,actionActive:t.value,"onAction-click":B}),{"action-icon":({active:L})=>e("span",{style:{alignItems:"center",color:L?"white":"var(--neo-theme-color)",display:"inline-flex",fontSize:"11px",fontWeight:"700",gap:"2px"}},[L?p:v,a.value])})])}})},k={tags:["snapshot"],globals:{direction:"rtl"},args:{title:"عنوان لوحة الغلاف"}},h={tags:["snapshot"],render:n=>i({name:"AllColorsRender",setup(){return()=>e("div",{style:{display:"flex",flexWrap:"wrap",gap:"12px",padding:"16px"}},[be.map(a=>e("div",{key:a,style:{inlineSize:"120px"}},[e(r,l(c(n),{color:a,imageSrc:F(300,450),imageAlt:`Cover placeholder for ${a}`,clickBehavior:"none",actionAriaLabel:"Add to favorites"}),{"action-icon":({active:t})=>t?p:v})]))])}})},f={tags:["snapshot"],globals:{backgrounds:"#000"},render:n=>i({name:"AllColorsOnDarkRender",setup(){return()=>e("div",{class:"u-onDark",style:{display:"flex",flexWrap:"wrap",gap:"12px",padding:"16px"}},[be.map(a=>e("div",{key:a,style:{inlineSize:"120px"}},[e(r,l(c(n),{color:a,imageSrc:F(300,450),imageAlt:`Cover placeholder for ${a}`,clickBehavior:"none",actionAriaLabel:"Add to favorites"}),{"action-icon":({active:t})=>t?p:v})]))])}})},S={...h,tags:["!dev","test-only"],play:Ce()},x={...f,tags:["!dev","test-only"],play:Ce()};var w,z,D;A.parameters={...A.parameters,docs:{...(w=A.parameters)==null?void 0:w.docs,source:{originalSource:`{
  tags: ['snapshot'],
  parameters: {
    docs: {
      source: {
...
}`,...(V=(_=b.parameters)==null?void 0:_.docs)==null?void 0:V.source}}};var E,U,K;P.parameters={...P.parameters,docs:{...(E=P.parameters)==null?void 0:E.docs,source:{originalSource:`{
  tags: ['snapshot'],
  parameters: {
    docs: {
      source: {
...
}`,...(K=(U=P.parameters)==null?void 0:U.docs)==null?void 0:K.source}}};var Y,q,G,J,Q;g.parameters={...g.parameters,docs:{...(Y=g.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  tags: ['no-test'],
  parameters: {
    docs: {
      source: {
...
Pennants are absolutely positioned and do not affect panel dimensions.`,...(Q=(J=g.parameters)==null?void 0:J.docs)==null?void 0:Q.description}}};var X,Z,ee;C.parameters={...C.parameters,docs:{...(X=C.parameters)==null?void 0:X.docs,source:{originalSource:`{
  tags: ['snapshot'],
  parameters: {
    docs: {
      source: {
...
}`,...(ee=(Z=C.parameters)==null?void 0:Z.docs)==null?void 0:ee.source}}};var ne,oe,ae;y.parameters={...y.parameters,docs:{...(ne=y.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  tags: ['snapshot'],
  parameters: {
    docs: {
      source: {
...
<template>
...
}`,...(se=(ce=h.parameters)==null?void 0:ce.docs)==null?void 0:se.source}}};var de,pe,ve;f.parameters={...f.parameters,docs:{...(de=f.parameters)==null?void 0:de.docs,source:{originalSource:`{
  tags: ['snapshot'],
  globals: {
    backgrounds: '#000'
  },
...
}`,...(ve=(pe=f.parameters)==null?void 0:pe.docs)==null?void 0:ve.source}}};var me,ue,ge;S.parameters={...S.parameters,docs:{...(me=S.parameters)==null?void 0:me.docs,source:{originalSource:`{
  ...AllColors,
  tags: ['!dev', 'test-only'],
  play: createA11yPlay()
  ...
  tags: ['!dev', 'test-only'],
  play: createA11yPlay()
}`,...(Ae=(fe=x.parameters)==null?void 0:fe.docs)==null?void 0:Ae.source}}};const We=["Default","ImageClickAndActionButton","LinkMode","WithPennants","WithManyPennants","ActionActive","WithActionCount","RTL","AllColors","AllColorsOnDark","AllColorsA11y","AllColorsOnDarkA11y"];export{C as ActionActive,h as AllColors,S as AllColorsA11y,f as AllColorsOnDark,x as AllColorsOnDarkA11y,A as Default,u as ImageClickAndActionButton,b as LinkMode,k as RTL,y as WithActionCount,g as WithManyPennants,P as WithPennants,We as __namedExportsOrder,De as default};
