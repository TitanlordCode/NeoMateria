import{d,c as r,F as p,b as j,h as E}from"./iframe-CDp9AjhM.js";import{p as I}from"./placeholder-CgeahcyT.js";import{a as M}from"./colorShowcase-noQHZ697.js";import{c as _}from"./createA11yPlay-dTN_hk15.js";import{N as t}from"./NeoHero-CX_YtgPN.js";import{a as $}from"./NeoHeadlineTypes-CVOcXnNm.js";import{N as m}from"./NeoButton-COUnjCyk.js";import{N as g}from"./NeoLinkButton-B2uhX11W.js";import{N as q}from"./NeoImage-DdBaNQbG.js";import"./preload-helper-Dp1pzeXC.js";import"./axe-XGHweOtN.js";import"./_plugin-vue_export-helper-DerOYOQE.js";import"./NeoHeadlinePrimary-Itdlk4en.js";import"./useHeadline-lZPeQlev.js";import"./NeoSection-DfpQeORw.js";import"./useButton-DL1fD-hW.js";import"./NeoIcon-Bozdex4T.js";const J=["centered","split"],K=["sm","md","lg"],Q=j.filter(e=>e!=="white"),me={title:"Organisms/NeoHero",component:t,tags:["autodocs"],argTypes:{title:{control:"text",table:{category:"Content"}},subtitle:{control:"text",table:{category:"Content"}},variant:{control:"select",options:J,description:"`centered` — stacked, text centered. `split` — text left, media right.",table:{category:"Appearance"}},size:{control:"select",options:K,description:"Controls vertical padding.",table:{category:"Appearance"}},headingTag:{control:"select",options:$,description:"HTML element for the heading. Defaults to `h1` — change only for non-page-level heroes.",table:{category:"Appearance"}},color:{control:"select",options:Q,description:"Accent color applied to the title.",table:{category:"Appearance"}},actions:{control:!1,description:"CTA buttons or interactive elements rendered below the headline and body copy.",table:{category:"Slots"}},media:{control:!1,description:"Media content (image, video) displayed beside the text in `split` variant.",table:{category:"Slots"}}},args:{title:"Build beautiful interfaces",subtitle:"A complete Vue 3 design system — accessible, themed, and ready for production.",variant:"centered",size:"md",color:"blue"}},n={tags:["snapshot"],render:e=>d({name:"CenteredRender",setup(){return()=>r(t,e,{actions:()=>r(p,null,[r(m,{text:"Get started",color:e.color??"blue",variant:"primary"},null),r(g,{href:"#",text:"View docs",color:e.color??"blue",variant:"secondary"},null)])})}}),parameters:{docs:{source:{code:`<NeoHero
