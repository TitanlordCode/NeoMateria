...
</div>`}}},render:t=>je({name:"GridLayoutRender",setup(){const n=[{...t,title:"Mountain Adventure",imageSrc:e(400,300),tags:[{text:"Travel",color:"blue"},{text:"Nature",color:"green"}]},{...t,title:"Creative Workshop",imageSrc:e(400,300),tags:[{text:"Design",color:"purple"},{text:"Art",color:"pink"}]},{...t,title:"Tech Innovation",imageSrc:e(400,300),tags:[{text:"Technology",color:"cyan"},{text:"Innovation",color:"indigo"}]},{...t,title:"Wellness Guide",imageSrc:e(400,300),tags:[{text:"Health",color:"green"},{text:"Lifestyle",color:"lime"}]}];return()=>P("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fill, minmax(280px, 1fr))",gap:"24px",padding:"24px"}},[n.map((a,r)=>P(i,Ge({key:r},a),null))])}})},v={...o,tags:["!dev"],play:async({args:t,canvasElement:n,step:a})=>{const r=qe(n);await a("Check action button click",async()=>{const N=r.getByText("View More");await Ke.click(N)}),await Ye(()=>Ue(t["onAction-click"]).toHaveBeenCalled())}},C={tags:["snapshot"],globals:{backgrounds:"#000"}},S={tags:["snapshot"],globals:{direction:"rtl"},args:{title:"عنوان المحتوى المميز",description:"هذا وصف قصير للبطاقة يوضح المحتوى المعروض.",actionText:"عرض المزيد",secondaryActionText:"تعرف على المزيد"}},s={tags:["snapshot"],render:_e(i,["default","compact","featured"],{defaultProps:{imageSrc:e(400,300)}})},c={tags:["snapshot"],globals:{backgrounds:"#000"},render:_e(i,["default","compact","featured"],{dark:!0,defaultProps:{imageSrc:e(400,300)}})},k={...s,tags:["!dev","test-only"],play:ze()},w={...c,tags:["!dev","test-only"],play:ze()};var D,M,B;o.parameters={...o.parameters,docs:{...(D=o.parameters)==null?void 0:D.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
...
}`,...(I=(V=u.parameters)==null?void 0:V.docs)==null?void 0:I.source}}};var U,K,Y;g.parameters={...g.parameters,docs:{...(U=g.parameters)==null?void 0:U.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
    rounded: true
  }
}`,...(Y=(K=g.parameters)==null?void 0:K.docs)==null?void 0:Y.source}}};var q,J,Q;m.parameters={...m.parameters,docs:{...(q=m.parameters)==null?void 0:q.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
    description: undefined
  }
}`,...(Q=(J=m.parameters)==null?void 0:J.docs)==null?void 0:Q.source}}};var X,Z,$;f.parameters={...f.parameters,docs:{...(X=f.parameters)==null?void 0:X.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
    tags: []
  }
}`,...($=(Z=f.parameters)==null?void 0:Z.docs)==null?void 0:$.source}}};var ee,te,ne;h.parameters={...h.parameters,docs:{...(ee=h.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
    actionText: undefined,
    secondaryActionText: undefined
  }
}`,...(ne=(te=h.parameters)==null?void 0:te.docs)==null?void 0:ne.source}}};var ae,re,oe;x.parameters={...x.parameters,docs:{...(ae=x.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
    description: undefined,
    tags: [],
...
}`,...(pe=(de=b.parameters)==null?void 0:de.docs)==null?void 0:pe.source}}};var ue,ge,me;A.parameters={...A.parameters,docs:{...(ue=A.parameters)==null?void 0:ue.docs,source:{originalSource:`{
  tags: ['no-test'],
  parameters: {
    docs: {
      source: {
...
}`,...(me=(ge=A.parameters)==null?void 0:ge.docs)==null?void 0:me.source}}};var fe,he,xe;T.parameters={...T.parameters,docs:{...(fe=T.parameters)==null?void 0:fe.docs,source:{originalSource:`{
  tags: ['snapshot'],
  parameters: {
    docs: {
      source: {
...
}`,...(xe=(he=T.parameters)==null?void 0:he.docs)==null?void 0:xe.source}}};var ye,be,Ae;v.parameters={...v.parameters,docs:{...(ye=v.parameters)==null?void 0:ye.docs,source:{originalSource:`{
  ...Default,
  tags: ['!dev'],
  play: async ({
    args,
...
}`,...(Ae=(be=v.parameters)==null?void 0:be.docs)==null?void 0:Ae.source}}};var Te,ve,Ce;C.parameters={...C.parameters,docs:{...(Te=C.parameters)==null?void 0:Te.docs,source:{originalSource:`{
  tags: ['snapshot'],
  globals: {
    backgrounds: '#000'
  }
}`,...(Ce=(ve=C.parameters)==null?void 0:ve.docs)==null?void 0:Ce.source}}};var Se,ke,we;S.parameters={...S.parameters,docs:{...(Se=S.parameters)==null?void 0:Se.docs,source:{originalSource:`{
  tags: ['snapshot'],
  globals: {
    direction: 'rtl'
  },
