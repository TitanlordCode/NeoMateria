import{b as A,d as t,c as e}from"./iframe-Bg0OttVg.js";import{N as n}from"./NeoHeadingGroup-BKJCBuOe.js";import{h as S}from"./NeoHeadingGroupTypes-C1ovxeqr.js";import{h as D,a as k}from"./NeoHeadlineTypes-CVOcXnNm.js";import"./preload-helper-Dp1pzeXC.js";import"./_plugin-vue_export-helper-DerOYOQE.js";import"./NeoHeadlinePrimary-BkKyzwYv.js";import"./useHeadline-DfckPeyI.js";import"./NeoHeadlineSecondary-B66F3LPf.js";import"./NeoHeadlineTertiary-D2VZDy6n.js";const z={title:"Molecules/NeoHeadingGroup",component:n,tags:["autodocs"],argTypes:{title:{control:"text",table:{category:"Content"},description:"The main title text of the group."},subtitle:{control:"text",table:{category:"Content"},description:"Supporting text rendered below the title."},overline:{control:"text",description:"Small uppercase label rendered above the title.",table:{category:"Content"}},variant:{control:"select",options:S,description:"Controls which headline size is used for the title.",table:{category:"Appearance"}},headingTag:{control:"select",options:k,description:"The HTML element for the title. Decouples visual size from document semantics.",table:{category:"Appearance"}},align:{control:"select",options:D,description:"Text alignment for the entire group.",table:{category:"Appearance"}},color:{control:"select",options:A,description:"Accent color applied to the title and overline.",table:{category:"Appearance"}}},args:{title:"Section Heading",variant:"primary"},parameters:{snapshot:{viewports:["sm","md","lg","xl"]}}},o={tags:["snapshot"],render:r=>t({name:"DefaultRender",setup(){return()=>e(n,r,null)}}),parameters:{docs:{source:{code:'<NeoHeadingGroup title="Section Heading" />'}}}},a={tags:["snapshot"],args:{overline:"Features",title:"Everything You Need",subtitle:"A complete design system for building beautiful interfaces at scale.",color:"blue"},render:r=>t({name:"WithOverlineRender",setup(){return()=>e(n,r,null)}}),parameters:{docs:{source:{code:`<NeoHeadingGroup
  overline="Features"
...
}`,...(d=(p=o.parameters)==null?void 0:p.docs)==null?void 0:d.source}}};var u,g,m;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
    overline: 'Features',
    title: 'Everything You Need',
