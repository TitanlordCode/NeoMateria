import{d as c,c as r,F as i,b as z,h as V}from"./iframe-BNVHVJhn.js";import{p as R}from"./placeholder-J2GqGUFJ.js";import{a as G}from"./colorShowcase-BzxvNubM.js";import{N as t}from"./NeoHero-Byg9ULN5.js";import{a as L}from"./NeoHeadlineTypes-CVOcXnNm.js";import{N as d}from"./NeoButton-364jGlWI.js";import{N as u}from"./NeoLinkButton-B-ugfULf.js";import{N as w}from"./NeoImage-C_2VXNk2.js";import"./preload-helper-Dp1pzeXC.js";import"./_plugin-vue_export-helper-DerOYOQE.js";import"./NeoHeadlinePrimary-BWLdawQg.js";import"./useHeadline-B1vqXKMh.js";import"./useButton-DryRKbhE.js";import"./NeoIcon-CGZgoonz.js";const D=["centered","split"],O=["sm","md","lg"],P=z.filter(e=>e!=="white"),X={title:"Organisms/NeoHero",component:t,tags:["autodocs"],argTypes:{title:{control:"text",table:{category:"Content"}},subtitle:{control:"text",table:{category:"Content"}},variant:{control:"select",options:D,description:"`centered` — stacked, text centered. `split` — text left, media right.",table:{category:"Appearance"}},size:{control:"select",options:O,description:"Controls vertical padding.",table:{category:"Appearance"}},headingTag:{control:"select",options:L,description:"HTML element for the heading. Defaults to `h1` — change only for non-page-level heroes.",table:{category:"Appearance"}},color:{control:"select",options:P,description:"Accent color applied to the title.",table:{category:"Appearance"}}},args:{title:"Build beautiful interfaces",subtitle:"A complete Vue 3 design system — accessible, themed, and ready for production.",variant:"centered",size:"md",color:"blue"}},o={render:e=>c({name:"CenteredRender",setup(){return()=>r(t,e,{actions:()=>r(i,null,[r(d,{text:"Get started",color:e.color??"blue",variant:"primary"},null),r(u,{href:"#",text:"View docs",color:e.color??"blue",variant:"secondary"},null)])})}}),parameters:{docs:{source:{code:`<NeoHero
