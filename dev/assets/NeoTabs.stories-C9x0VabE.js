...
</template>`}}},render:n=>g({name:"ControlledRender",setup(){const a=w("details");return()=>{let e,s,d;return t("div",{style:{display:"flex",flexDirection:"column",gap:"16px"}},[t("p",{style:{color:"var(--neo-color-grey600)",fontSize:"14px",margin:0}},[Q("Active tab: "),t("strong",null,[a.value])]),t(h,ca(n,{activeTab:a.value,"onTab-change":m=>{a.value=m}}),{default:()=>[t(i,{id:"overview",label:"Overview"},l(e=p("Overview","Controlled mode — the parent owns the active tab state."))?e:{default:()=>[e]}),t(i,{id:"details",label:"Details"},l(s=p("Details","Update activeTab in @tab-change to keep the component in sync."))?s:{default:()=>[s]}),t(i,{id:"history",label:"History"},l(d=p("History","Useful when you need to conditionally prevent tab switches."))?d:{default:()=>[d]})]})])}}})},K={tags:["snapshot"],parameters:{snapshot:{viewports:["md","xl"]},docs:{source:{code:`<NeoTabs color="blue">
...
}`,...(Ge=(Le=K.parameters)==null?void 0:Le.docs)==null?void 0:Ge.source}}};var Ye,Je,Qe;L.parameters={...L.parameters,docs:{...(Ye=L.parameters)==null?void 0:Ye.docs,source:{originalSource:`{
  tags: ['snapshot'],
  parameters: {
    snapshot: {
      viewports: ['sm', 'xl']
...
}`,...(Qe=(Je=L.parameters)==null?void 0:Je.docs)==null?void 0:Qe.source}}};var Xe,Ze,ea;G.parameters={...G.parameters,docs:{...(Xe=G.parameters)==null?void 0:Xe.docs,source:{originalSource:`{
  tags: ['no-test'],
  parameters: {
    docs: {
      source: {
...
}`,...(ea=(Ze=G.parameters)==null?void 0:Ze.docs)==null?void 0:ea.source}}};var aa,ta,na;Y.parameters={...Y.parameters,docs:{...(aa=Y.parameters)==null?void 0:aa.docs,source:{originalSource:`{
  tags: ['snapshot'],
  globals: {
    backgrounds: '#000'
  },
...
\${indentSrc(defaultPanelsSrc, 2)}
  ...
  render: Default.render
}`,...(na=(ta=Y.parameters)==null?void 0:ta.docs)==null?void 0:na.source}}};var sa,oa,ra;J.parameters={...J.parameters,docs:{...(sa=J.parameters)==null?void 0:sa.docs,source:{originalSource:`{
  tags: ['!dev'],
  render: (args: NeoTabsProps) => defineComponent({
...
}`,...(ra=(oa=J.parameters)==null?void 0:oa.docs)==null?void 0:ra.source}}};const dt=["Default","Pills","Filled","Vertical","Small","Large","FullWidth","WithDisabledTab","Controlled","WithRichContent","ManyTabs","AllVariants","OnDark","Interaction"];export{G as AllVariants,F as Controlled,f as Default,V as Filled,M as FullWidth,J as Interaction,j as Large,L as ManyTabs,Y as OnDark,B as Pills,W as Small,q as Vertical,U as WithDisabledTab,K as WithRichContent,dt as __namedExportsOrder,lt as default};
