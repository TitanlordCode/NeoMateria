import{d as Y,c as m,m as Q}from"./iframe-BNVHVJhn.js";import{N as r}from"./NeoSpinner-DpVB9DJu.js";import{N as Z}from"./NeoButton-364jGlWI.js";import{c as U}from"./colorShowcase-BzxvNubM.js";import"./preload-helper-Dp1pzeXC.js";import"./_plugin-vue_export-helper-DerOYOQE.js";import"./useButton-DryRKbhE.js";import"./NeoIcon-CGZgoonz.js";const $=["small","medium","large"],ie={title:"Atoms/NeoSpinner",component:r,tags:["autodocs"],argTypes:{color:{description:"Theme color of the spinning indicator."},size:{control:"select",options:$,table:{category:"Appearance"},description:"Controls the spinner diameter."},label:{control:"text",table:{category:"Accessibility"},description:"Visible text label rendered alongside the spinner."},ariaLabel:{control:"text",table:{category:"Accessibility"},description:"Screen-reader label when no visible label is shown. Defaults to 'Loading' if omitted."}},args:{size:"medium",color:"blue",ariaLabel:"Loading"}},a={},o={args:{size:"small"}},n={args:{size:"large"}},s={args:{label:"Please wait...",dir:"row"}},t={args:{label:"Please wait..."}},l={},i={parameters:{docs:{source:{code:`<NeoButton text="Loading..." color="blue" variant="primary">
  <template #prefix>
