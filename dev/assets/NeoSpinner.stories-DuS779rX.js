import{d as te,c as b,m as ae}from"./iframe-C_ND6_Fy.js";import{N as r}from"./NeoSpinner-bebXoHq_.js";import{N as le}from"./NeoButton-DL4iY5Bo.js";import{c as se}from"./colorShowcase-ZQoqWeMk.js";import{c as oe}from"./createA11yPlay-aiOB0shI.js";import"./preload-helper-Dp1pzeXC.js";import"./_plugin-vue_export-helper-DerOYOQE.js";import"./useButton-M8LrH6bz.js";import"./NeoIcon-BfOP21YS.js";import"./axe-DJZzUp1X.js";const ie=["small","medium","large"],ye={title:"Atoms/NeoSpinner",component:r,tags:["autodocs"],argTypes:{color:{description:"Theme color of the spinning indicator."},size:{control:"select",options:ie,table:{category:"Appearance"},description:"Controls the spinner diameter."},label:{control:"text",table:{category:"Accessibility"},description:"Visible text label rendered alongside the spinner."},ariaLabel:{control:"text",table:{category:"Accessibility"},description:"Screen-reader label when no visible label is shown. Defaults to 'Loading' if omitted."}},args:{size:"medium",color:"blue",ariaLabel:"Loading"},parameters:{snapshot:{viewports:["sm","lg","xl"]}}},o={tags:["snapshot"]},n={tags:["snapshot"],args:{size:"small"}},t={tags:["snapshot"],args:{size:"large"}},l={tags:["snapshot"],args:{label:"Please wait...",dir:"row"}},i={tags:["snapshot"],args:{label:"Please wait..."}},p={tags:["snapshot"]},c={tags:["snapshot"],parameters:{docs:{source:{code:`<NeoButton text="Loading..." color="blue" variant="primary">
  <template #prefix>
