...
</NeoButton>`}}},render:e=>D({name:"LoadingRender",setup(){return()=>t(r,e,{prefix:()=>t(qe,{size:"small",color:e.color,ariaHidden:!0},null)})}})},k={tags:["!dev"],render:()=>D({name:"InteractionRender",setup(){const e=$e(!1);return()=>t(r,{color:"blue",variant:"primary",onClick:()=>{e.value=!0}},{default:()=>[e.value?"Clicked!":"Click me"]})}}),play:async({canvasElement:e,step:Ze})=>{const I=lt(e);await Ze("Click fires and updates component state",async()=>{await it.click(I.getByRole("button",{name:"Click me"})),await st(I.getByRole("button")).toHaveTextContent("Clicked!")})}},C={tags:["snapshot"],globals:{backgrounds:"#000"}},A={tags:["snapshot"],globals:{direction:"rtl"},args:{text:"انقر هنا"}},a={tags:["snapshot"],render:Qe(r,["primary","secondary","tertiary","ghost"])},o={tags:["snapshot"],globals:{backgrounds:"#000"},render:Qe(r,["primary","secondary","tertiary","ghost"],{dark:!0})},B={...a,tags:["!dev","test-only"],play:Xe()},N={...o,tags:["!dev","test-only"],play:Xe()};var W,w,R;n.parameters={...n.parameters,docs:{...(W=n.parameters)==null?void 0:W.docs,source:{originalSource:`{
  tags: ['snapshot']
}`,...(R=(w=n.parameters)==null?void 0:w.docs)==null?void 0:R.source}}};var z,T,O;s.parameters={...s.parameters,docs:{...(z=s.parameters)==null?void 0:z.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
    size: 'small'
  }
}`,...(O=(T=s.parameters)==null?void 0:T.docs)==null?void 0:O.source}}};var P,L,G;c.parameters={...c.parameters,docs:{...(P=c.parameters)==null?void 0:P.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
    size: 'large'
  }
...
}`,...(re=(te=m.parameters)==null?void 0:te.docs)==null?void 0:re.source}}};var ae,oe,ne;g.parameters={...g.parameters,docs:{...(ae=g.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
    variant: 'ghost',
...
}`,...(ne=(oe=g.parameters)==null?void 0:oe.docs)==null?void 0:ne.source}}};var se,ce,ie;h.parameters={...h.parameters,docs:{...(se=h.parameters)==null?void 0:se.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
...
<NeoButton text="Loading..." color="blue" variant="primary">
...
}`,...(Ne=(Be=v.parameters)==null?void 0:Be.docs)==null?void 0:Ne.source}}};var De,Ee,Ie;k.parameters={...k.parameters,docs:{...(De=k.parameters)==null?void 0:De.docs,source:{originalSource:`{
  tags: ['!dev'],
...
}`,...(Ie=(Ee=k.parameters)==null?void 0:Ee.docs)==null?void 0:Ie.source}}};var We,we,Re;C.parameters={...C.parameters,docs:{...(We=C.parameters)==null?void 0:We.docs,source:{originalSource:`{
  tags: ['snapshot'],
  globals: {
    backgrounds: '#000'
  }
...
}`,...(Ge=(Le=a.parameters)==null?void 0:Le.docs)==null?void 0:Ge.source}}};var Ve,_e,Fe;o.parameters={...o.parameters,docs:{...(Ve=o.parameters)==null?void 0:Ve.docs,source:{originalSource:`{
  tags: ['snapshot'],
  globals: {
    backgrounds: '#000'
  },
...
}`,...(Fe=(_e=o.parameters)==null?void 0:_e.docs)==null?void 0:Fe.source}}};var He,Ue,Me;B.parameters={...B.parameters,docs:{...(He=B.parameters)==null?void 0:He.docs,source:{originalSource:`{
  ...AllColors,
  tags: ['!dev', 'test-only'],
  play: createA11yPlay()
  ...
  tags: ['!dev', 'test-only'],
  play: createA11yPlay()
}`,...(je=(Ye=N.parameters)==null?void 0:Ye.docs)==null?void 0:je.source}}};const At=["Default","Small","large","Disabled","Rounded","Secondary","Tertiary","Ghost","GhostWithIcon","FullWidth","WithIconStart","WithIconEnd","WithIconStartAndEnd","Pressed","PressedDisabled","SlotDefault","Loading","interaction","OnDark","RTL","AllColors","AllColorsOnDark","AllColorsA11y","AllColorsOnDarkA11y"];export{a as AllColors,B as AllColorsA11y,o as AllColorsOnDark,N as AllColorsOnDarkA11y,n as Default,i as Disabled,g as FullWidth,u as Ghost,m as GhostWithIcon,v as Loading,C as OnDark,S as Pressed,f as PressedDisabled,A as RTL,l as Rounded,d as Secondary,x as SlotDefault,s as Small,p as Tertiary,b as WithIconEnd,h as WithIconStart,y as WithIconStartAndEnd,At as __namedExportsOrder,Ct as default,k as interaction,c as large};
