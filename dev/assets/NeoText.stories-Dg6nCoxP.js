import{b as F,d as m,c as r,a as n,i as H,h as q}from"./iframe-CDp9AjhM.js";import{a as M}from"./colorShowcase-noQHZ697.js";import{c as X}from"./createA11yPlay-dTN_hk15.js";import{N as o}from"./NeoText-BGmLwJfq.js";import"./preload-helper-Dp1pzeXC.js";import"./axe-XGHweOtN.js";import"./_plugin-vue_export-helper-DerOYOQE.js";const W=["lead","base","small","caption"],G=["p","span","div"],I=["regular","medium","semibold","bold"];function E(e){return typeof e=="function"||Object.prototype.toString.call(e)==="[object Object]"&&!H(e)}const te={title:"Atoms/NeoText",component:o,tags:["autodocs"],argTypes:{size:{control:"select",options:W,description:"`lead` — large intro text (textXl, relaxed). `base` — body copy (textMd, normal). `small` — secondary labels (textSm). `caption` — fine print (textXs).",table:{category:"Appearance"}},tag:{control:"select",options:G,description:"HTML element to render. Defaults to `p`.",table:{category:"Appearance"}},color:{control:"select",options:F,description:"Optional accent color applied via the themed system (`colorAccessible` shade).",table:{category:"Appearance"}},weight:{control:"select",options:I,description:"Font weight override. Defaults to inherited weight (regular).",table:{category:"Appearance"}},truncate:{control:"boolean",description:"Truncates overflowing text to a single line with an ellipsis.",table:{category:"Appearance"}},clamp:{control:"number",description:"Clamps text to the given number of lines with an ellipsis.",table:{category:"Appearance"}},default:{control:!1,description:"The text content.",table:{category:"Slots"}}},args:{size:"base"},parameters:{snapshot:{viewports:["sm","lg","xl"]}}},t="The quick brown fox jumps over the lazy dog. Pack my box with five dozen liquor jugs.",l={tags:["snapshot"],render:e=>m({name:"DefaultRender",setup(){return()=>r(o,e,E(t)?t:{default:()=>[t]})}}),parameters:{docs:{source:{code:`<NeoText>${t}</NeoText>`}}}},u={tags:["snapshot"],render:()=>m({name:"AllSizesRender",setup(){return()=>r("div",{style:{display:"flex",flexDirection:"column",gap:"16px"}},[r(o,{size:"lead"},{default:()=>[n("lead — "),t]}),r(o,{size:"base"},{default:()=>[n("base — "),t]}),r(o,{size:"small"},{default:()=>[n("small — "),t]}),r(o,{size:"caption"},{default:()=>[n("caption — "),t]})])}}),parameters:{docs:{source:{code:`<NeoText size="lead">Lead text</NeoText>
<NeoText size="base">Base text</NeoText>
<NeoText size="small">Small text</NeoText>
<NeoText size="caption">Caption text</NeoText>`}}}},p={tags:["snapshot"],args:{color:"blue"},render:e=>m({name:"ColoredRender",setup(){return()=>r(o,e,E(t)?t:{default:()=>[t]})}}),parameters:{docs:{source:{code:`<NeoText color="blue">${t}</NeoText>`}}}},c={tags:["snapshot"],globals:{direction:"rtl"},parameters:{snapshot:{viewports:["sm","xl"]}},render:e=>m({name:"RTLRender",setup(){return()=>r(o,e,{default:()=>[n("الثعلب البني السريع يقفز فوق الكلب الكسول")]})}})},a={tags:["snapshot"],parameters:{snapshot:{viewports:["sm","xl"]}},render:M(o,[{name:"Default",variant:"default",renderComponent:(e,x)=>q(x,{color:e},{default:()=>e})}])},s={tags:["snapshot"],globals:{backgrounds:"#000"},parameters:{snapshot:{viewports:["sm","xl"]}},render:M(o,[{name:"Default",variant:"default",renderComponent:(e,x)=>q(x,{color:e},{default:()=>e})}],!0)},d={...a,tags:["!dev","test-only"],play:X()},i={...s,tags:["!dev","test-only"],play:X()};var T,g,f;l.parameters={...l.parameters,docs:{...(T=l.parameters)==null?void 0:T.docs,source:{originalSource:`{
  tags: ['snapshot'],
...
}`,...(f=(g=l.parameters)==null?void 0:g.docs)==null?void 0:f.source}}};var N,b,y;u.parameters={...u.parameters,docs:{...(N=u.parameters)==null?void 0:N.docs,source:{originalSource:`{
  tags: ['snapshot'],
  render: () => {
    return defineComponent({
      name: 'AllSizesRender',
...
}`,...(L=(O=s.parameters)==null?void 0:O.docs)==null?void 0:L.source}}};var P,j,B;d.parameters={...d.parameters,docs:{...(P=d.parameters)==null?void 0:P.docs,source:{originalSource:`{
  ...AllColors,
  tags: ['!dev', 'test-only'],
  play: createA11yPlay()
}`,...(B=(j=d.parameters)==null?void 0:j.docs)==null?void 0:B.source}}};var $,V,_;i.parameters={...i.parameters,docs:{...($=i.parameters)==null?void 0:$.docs,source:{originalSource:`{
  ...AllColorsOnDark,
  tags: ['!dev', 'test-only'],
  play: createA11yPlay()
}`,...(_=(V=i.parameters)==null?void 0:V.docs)==null?void 0:_.source}}};const oe=["Default","AllSizes","Colored","RTL","AllColors","AllColorsOnDark","AllColorsA11y","AllColorsOnDarkA11y"];export{a as AllColors,d as AllColorsA11y,s as AllColorsOnDark,i as AllColorsOnDarkA11y,u as AllSizes,p as Colored,l as Default,c as RTL,oe as __namedExportsOrder,te as default};
