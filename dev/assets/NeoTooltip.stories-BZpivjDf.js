import{N as p}from"./NeoTooltip-Dt2mo3wf.js";import{N as W}from"./NeoButton-GRseUT4r.js";import{c as z}from"./createA11yPlay-DxivIEqv.js";import"./iframe-Bg0OttVg.js";import"./preload-helper-Dp1pzeXC.js";import"./_plugin-vue_export-helper-DerOYOQE.js";import"./useButton-BSwY0W_p.js";import"./NeoIcon-X07-7rWn.js";import"./axe-CjNTfdGc.js";const H=["top","bottom","left","right"],e=()=>({template:'<div style="display: flex; justify-content: center; align-items: center; min-block-size: 160px; padding: 80px 200px;"><story /></div>'}),G={title:"Atoms/NeoTooltip",component:p,tags:["autodocs"],parameters:{layout:"centered",snapshot:{viewports:["sm","lg","xl"]}},argTypes:{text:{control:"text",table:{category:"Content"},description:"Tooltip text shown on hover/focus of the trigger."},placement:{control:"select",options:H,table:{category:"Behavior"},description:"Which side of the trigger the tooltip appears on."},openDelay:{control:"number",table:{category:"Behavior"},description:"Milliseconds to wait before showing the tooltip."},visible:{control:"boolean",table:{category:"State"},description:"Force the tooltip to stay visible (useful for docs and testing)."}},args:{text:"Helpful tooltip text",placement:"top",openDelay:0,visible:!1},render:O=>({components:{NeoTooltip:p,NeoButton:W},setup:()=>({args:O}),template:`
