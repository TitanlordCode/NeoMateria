import{d as p,c as n,r as F,F as ae,i as ce}from"./iframe-D97hRsDr.js";import{p as m}from"./placeholder-CgeahcyT.js";import{N as s}from"./NeoCoverPanelGrid-Blt1Q1kI.js";import{N as c}from"./NeoCoverPanel-B96i1nxi.js";import{N as G}from"./NeoPennant-CMJHjvMs.js";import{S as A}from"./defaultIcons-Cw98xW-y.js";import"./preload-helper-Dp1pzeXC.js";import"./NeoSection-B5MUP6FZ.js";import"./_plugin-vue_export-helper-DerOYOQE.js";import"./NeoImage-26gpCn16.js";import"./iconStrings-DvlgHS7z.js";const se=["small","medium","large"];function l(r){return typeof r=="function"||Object.prototype.toString.call(r)==="[object Object]"&&!ce(r)}const we={title:"Organisms/NeoCoverPanelGrid",component:s,tags:["autodocs"],parameters:{docs:{description:{component:"\nA responsive grid layout for `NeoCoverPanel` items. Uses CSS `auto-fill` with a `minmax` column constraint — the grid drops columns as the container narrows, but never exceeds `columns`.\n\n**How `columns` and `minColumnWidth` interact:**\nThe grid tries to fill as many columns as possible. `minColumnWidth` is the floor — a column will never be narrower than this value. `columns` is the ceiling — the grid will never add more columns than this even when space allows.\n\nSet `minColumnWidth` based on the minimum readable size of your content. Lower values produce more columns at medium widths.\n\nThis component wraps itself in a `NeoSection`. If you place it **inside another `NeoSection`**, it auto-detects the ancestor and skips its own wrapper — so you never get a doubled section (which would break the inner grid's percentage track sizing at wide viewports). To force-skip the wrapper in any other container, set `no-section`.\n                "}},controls:{exclude:["color"]}},argTypes:{columns:{control:{type:"number",min:2,max:8,step:1},description:"Maximum number of columns at full container width. Works with `minColumnWidth` — see component docs for full explanation.",table:{category:"Layout"}},minColumnWidth:{control:{type:"number",min:80,max:400,step:10},description:"Minimum pixel width each column must be before the grid drops a column. Defaults to `160`.",table:{category:"Layout"}},gap:{control:"select",options:se,description:"Gap between grid items. `small` = `--neo-gap-sm`, `medium` = `--neo-gap-md`, `large` = `--neo-gap-lg`.",table:{category:"Layout"}},section:{control:!1,description:"Props forwarded to the internal `NeoSection` wrapper (e.g. `fullWidth`).",table:{category:"Layout"}},noSection:{control:"boolean",description:"Force-skip the internal `NeoSection` wrapper. A `NeoSection` ancestor is auto-detected and skipped already; use this to opt out inside non-`NeoSection` containers.",table:{category:"Layout"}}},args:{columns:4,minColumnWidth:160,gap:"medium"}},i=["#64748b","#475569","#334155","#6366f1","#8b5cf6","#ec4899","#ef4444","#f97316","#eab308","#22c55e","#06b6d4","#3b82f6"],u=Array.from({length:12},(r,o)=>({imageSrc:m(300,450,i[o%i.length]),imageAlt:`Cover ${o+1}`,title:`Item ${o+1}`,color:"blue"})),de=n("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round","aria-hidden":"true",style:{blockSize:"18px",inlineSize:"18px"}},[n("path",{d:"M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"},null)]),pe=n("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"currentColor","aria-hidden":"true",style:{blockSize:"18px",inlineSize:"18px"}},[n("path",{d:"M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"},null)]),ue=n("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round","aria-hidden":"true",style:{blockSize:"18px",inlineSize:"18px"}},[n("path",{d:"M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"},null)]),ge=n("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"currentColor","aria-hidden":"true",style:{blockSize:"18px",inlineSize:"18px"}},[n("path",{d:"M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"},null)]),f={tags:["snapshot"],render:r=>p({name:"DefaultRender",setup(){return()=>{let o;return n(s,r,l(o=u.map(e=>n(c,{key:e.imageSrc,color:e.color,imageSrc:e.imageSrc,imageAlt:e.imageAlt,title:e.title},null)))?o:{default:()=>[o]})}}}),parameters:{docs:{source:{code:`<NeoCoverPanelGrid :columns="4" gap="medium">
  <NeoCoverPanel
    ...
    :title="item.title"
  />
</NeoCoverPanelGrid>`}}}},N={tags:["snapshot"],args:{columns:2},render:r=>p({name:"TwoColumnsRender",setup(){return()=>{let o;return n("div",{style:{padding:"16px"}},[n(s,r,l(o=u.slice(0,6).map(e=>n(c,{key:e.imageSrc,color:e.color,imageSrc:e.imageSrc,imageAlt:e.imageAlt,title:e.title},null)))?o:{default:()=>[o]})])}}}),parameters:{docs:{source:{code:`<NeoCoverPanelGrid :columns="2" gap="medium">
  <NeoCoverPanel
    v-for="item in items"
    :key="item.id"
    :color="item.color"
    ...
    :title="item.title"
  />
</NeoCoverPanelGrid>`}}}},h={tags:["snapshot"],args:{columns:6,minColumnWidth:120},render:r=>p({name:"SixColumnsRender",setup(){return()=>{let o;return n("div",{style:{padding:"16px"}},[n(s,r,l(o=u.map(e=>n(c,{key:e.imageSrc,color:e.color,imageSrc:e.imageSrc,imageAlt:e.imageAlt,title:e.title,rounded:!0},null)))?o:{default:()=>[o]})])}}}),parameters:{docs:{source:{code:`<NeoCoverPanelGrid :columns="6" :min-column-width="120" gap="medium">
  <NeoCoverPanel
    v-for="item in items"
    :key="item.id"
    :color="item.color"
    ...
    rounded
  />
</NeoCoverPanelGrid>`}}}},k={tags:["snapshot"],render:r=>{const o=[{rank:"yellow",platform:"blue"},{rank:"yellow",platform:"blueGrey"},{rank:"yellow",platform:"purple"},{rank:"grey",platform:"red"},{rank:"grey",platform:"blue"},{rank:"grey",platform:"green"},{rank:"grey",platform:"blueGrey"},{rank:"grey",platform:"purple"}];return p({name:"WithPennantsRender",setup(){return()=>{let e;return n(s,r,l(e=u.slice(0,8).map((d,v)=>n(c,{key:d.imageSrc,color:"blue",imageSrc:d.imageSrc,imageAlt:d.imageAlt,title:d.title,rounded:!0},{pennants:()=>n(ae,null,[n(G,{color:o[v].platform},l(A)?A:{default:()=>[A]}),n(G,{color:o[v].rank},{default:()=>[v+1]})])})))?e:{default:()=>[e]})}}})},parameters:{docs:{source:{code:`<NeoCoverPanelGrid :columns="4" gap="medium">
  <NeoCoverPanel
...
</NeoCoverPanelGrid>`}}}},C={tags:["no-test"],render:r=>{const o=[{imageSrc:m(300,450,i[0]),imageAlt:"Cover 1",title:"Item 1",color:"blue",rounded:!0,pennants:[{color:"blue",content:"star"},{color:"yellow",content:"number",rank:1}],action:"favorite"},{imageSrc:m(300,450,i[1]),imageAlt:"Cover 2",title:"Item 2",color:"purple",rounded:!0,pennants:[{color:"yellow",content:"number",rank:2}],action:"bookmark"},{imageSrc:m(300,450,i[2]),imageAlt:"Cover 3",title:"Item 3",color:"green",rounded:!0,pennants:[{color:"green",content:"star"},{color:"grey",content:"number",rank:3}],action:"favorite"},{imageSrc:m(300,450,i[3]),imageAlt:"Cover 4",title:"Item 4",color:"indigo",pennants:[{color:"red",content:"star"}]},{imageSrc:m(300,450,i[4]),imageAlt:"Cover 5",title:"Item 5",color:"red",rounded:!0,action:"favorite"},{imageSrc:m(300,450,i[5]),imageAlt:"Cover 6",title:"Item 6",color:"pink",pennants:[{color:"purple",content:"star"},{color:"pink",content:"star"},{color:"grey",content:"number",rank:6}],action:"bookmark"},{imageSrc:m(300,450,i[6]),imageAlt:"Cover 7",title:"Item 7",color:"orange",rounded:!0},{imageSrc:m(300,450,i[7]),imageAlt:"Cover 8",title:"Item 8",color:"teal",pennants:[{color:"teal",content:"number",rank:8}],action:"favorite"}];return p({name:"MixedContentRender",setup(){const e=F(new Set),d=F(new Set),v=a=>{const t=new Set(e.value);t.has(a)?t.delete(a):t.add(a),e.value=t},ie=a=>{const t=new Set(d.value);t.has(a)?t.delete(a):t.add(a),d.value=t},I=a=>a?{pennants:()=>n(ae,null,[a.map((t,g)=>n(G,{key:g,color:t.color},{default:()=>[t.content==="star"?A:t.rank]}))])}:{};return()=>{let a;return n(s,r,l(a=o.map((t,g)=>{let w;if(t.action){const P=t.action==="favorite",le=P?e.value.has(g):d.value.has(g),me=P?()=>v(g):()=>ie(g);return n(c,{key:t.imageSrc,color:t.color,imageSrc:t.imageSrc,imageAlt:t.imageAlt,title:t.title,rounded:t.rounded,clickBehavior:"action",actionAriaLabel:P?"Add to favorites":"Bookmark",actionActive:le,"onAction-click":me},{...I(t.pennants),"action-icon":({active:x})=>P?x?pe:de:x?ge:ue})}return n(c,{key:t.imageSrc,color:t.color,imageSrc:t.imageSrc,imageAlt:t.imageAlt,title:t.title,rounded:t.rounded,clickBehavior:"none"},l(w=I(t.pennants))?w:{default:()=>[w]})}))?a:{default:()=>[a]})}}})},parameters:{docs:{source:{code:`<NeoCoverPanelGrid :columns="4" gap="medium">
...
</NeoCoverPanelGrid>`}}}},S={tags:["no-test"],args:{gap:"large"},render:r=>p({name:"LargeGapRender",setup(){return()=>{let o;return n(s,r,l(o=u.slice(0,8).map(e=>n(c,{key:e.imageSrc,color:e.color,imageSrc:e.imageSrc,imageAlt:e.imageAlt,title:e.title},null)))?o:{default:()=>[o]})}}}),parameters:{docs:{source:{code:`<NeoCoverPanelGrid :columns="4" gap="large">
  <NeoCoverPanel
    v-for="item in items"
    :key="item.id"
    :color="item.color"
    ...
    :title="item.title"
  />
</NeoCoverPanelGrid>`}}}},y={tags:["snapshot"],args:{section:{fullWidth:!0}},render:r=>p({name:"FullWidthRender",setup(){return()=>{let o;return n(s,r,l(o=u.map(e=>n(c,{key:e.imageSrc,color:e.color,imageSrc:e.imageSrc,imageAlt:e.imageAlt,title:e.title},null)))?o:{default:()=>[o]})}}}),parameters:{docs:{source:{code:`<NeoCoverPanelGrid :columns="4" gap="medium" :section="{fullWidth: true}">
  <NeoCoverPanel
    v-for="item in items"
    :key="item.id"
    :color="item.color"
    ...
    :title="item.title"
  />
</NeoCoverPanelGrid>`}}}},b={tags:["snapshot"],globals:{backgrounds:"#000"},parameters:{snapshot:{viewports:["sm","xl"]},docs:{source:{code:`<div class="u-onDark">
...
</div>`}}},render:r=>p({name:"OnDarkRender",setup(){return()=>{let o;return n("div",{class:"u-onDark",style:{padding:"16px"}},[n(s,r,l(o=u.map(e=>n(c,{key:e.imageSrc,color:e.color,imageSrc:e.imageSrc,imageAlt:e.imageAlt,title:e.title,rounded:!0},null)))?o:{default:()=>[o]})])}}})};var W,B,R;f.parameters={...f.parameters,docs:{...(W=f.parameters)==null?void 0:W.docs,source:{originalSource:`{
  tags: ['snapshot'],
...
}`,...(R=(B=f.parameters)==null?void 0:B.docs)==null?void 0:R.source}}};var L,z,D;N.parameters={...N.parameters,docs:{...(L=N.parameters)==null?void 0:L.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
    columns: 2
  },
...
}`,...(D=(z=N.parameters)==null?void 0:z.docs)==null?void 0:D.source}}};var _,M,H;h.parameters={...h.parameters,docs:{...(_=h.parameters)==null?void 0:_.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
    columns: 6,
    minColumnWidth: 120
...
}`,...(H=(M=h.parameters)==null?void 0:M.docs)==null?void 0:H.source}}};var T,O,j,V,$;k.parameters={...k.parameters,docs:{...(T=k.parameters)==null?void 0:T.docs,source:{originalSource:`{
  tags: ['snapshot'],
  render: (args: NeoCoverPanelGridProps) => {
...
}`,...(j=(O=k.parameters)==null?void 0:O.docs)==null?void 0:j.source},description:{story:`Pennants let you attach small colored badges to the top edge of each panel.
...
This story combines all optional props to show the full range of panel content.`,...(K=(J=C.parameters)==null?void 0:J.docs)==null?void 0:K.description}}};var Q,X,Y;S.parameters={...S.parameters,docs:{...(Q=S.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  tags: ['no-test'],
  args: {
    gap: 'large'
  },
...
}`,...(Y=(X=S.parameters)==null?void 0:X.docs)==null?void 0:Y.source}}};var Z,ee,ne;y.parameters={...y.parameters,docs:{...(Z=y.parameters)==null?void 0:Z.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
    section: {
      fullWidth: true
...
}`,...(ne=(ee=y.parameters)==null?void 0:ee.docs)==null?void 0:ne.source}}};var oe,te,re;b.parameters={...b.parameters,docs:{...(oe=b.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  tags: ['snapshot'],
  globals: {
    backgrounds: '#000'
  },
...
}`,...(re=(te=b.parameters)==null?void 0:te.docs)==null?void 0:re.source}}};const Ge=["Default","TwoColumns","SixColumns","WithPennants","MixedContent","LargeGap","FullWidth","OnDark"];export{f as Default,y as FullWidth,S as LargeGap,C as MixedContent,b as OnDark,h as SixColumns,N as TwoColumns,k as WithPennants,Ge as __namedExportsOrder,we as default};
