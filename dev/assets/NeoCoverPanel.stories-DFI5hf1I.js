import{d as i,c as e,m as l,b as be,r as I,a as F,F as Ce,i as ye}from"./iframe-D97hRsDr.js";import{N as r}from"./NeoCoverPanel-B96i1nxi.js";import{N as s}from"./NeoPennant-CMJHjvMs.js";import{H as d,b as v,S as o}from"./defaultIcons-Cw98xW-y.js";import{p as B}from"./placeholder-CgeahcyT.js";import{c as Pe}from"./createA11yPlay-BakXPOC5.js";import{s as N}from"./iconStrings-DvlgHS7z.js";import"./preload-helper-Dp1pzeXC.js";import"./_plugin-vue_export-helper-DerOYOQE.js";import"./NeoImage-26gpCn16.js";import"./axe-BAN8dmkr.js";const ke=["action","link","none"],{fn:R}=__STORYBOOK_MODULE_TEST__;function p(n){return typeof n=="function"||Object.prototype.toString.call(n)==="[object Object]"&&!ye(n)}const m=B(300,450),De={title:"Molecules/NeoCoverPanel",component:r,tags:["autodocs"],argTypes:{color:{description:"Theme color for overlays and action button accents.",table:{category:"Appearance"}},clickBehavior:{control:"select",options:ke,description:"`none`: image is decorative. `link`: image acts as a link (uses `href`). `action`: image triggers an action button — emits `image-click`.",table:{category:"Behavior"}},rounded:{control:"boolean",description:"Applies rounded corners to the panel.",table:{category:"Appearance"}},imageSrc:{control:"text",table:{category:"Content"},description:"Source URL of the cover image."},imageAlt:{control:"text",table:{category:"Content"},description:"Alt text for the cover image."},imageWidth:{control:"number",description:"Intrinsic width of the image in pixels. Set alongside `imageHeight` to prevent layout shift (CLS) before the image loads.",table:{category:"Content"}},imageHeight:{control:"number",description:"Intrinsic height of the image in pixels. Set alongside `imageWidth` to prevent layout shift (CLS) before the image loads.",table:{category:"Content"}},title:{control:"text",table:{category:"Content"},description:"Title shown on the panel overlay."},href:{control:"text",table:{category:"Behavior"},description:"Destination URL used when `clickBehavior` is `link`."},external:{control:"boolean",table:{category:"Behavior"},description:"Opens the link in a new tab with a safe `rel`. Only applies when `href` is set."},imageAriaLabel:{control:"text",description:"Accessible label for the image when it is interactive (`clickBehavior` is `link` or `action`).",table:{category:"Accessibility"}},actionAriaLabel:{control:"text",description:"Accessible label for the action button overlay.",table:{category:"Accessibility"}},actionActive:{control:"boolean",description:"Marks the action button as toggled on (e.g. a 'favored' state). Sets `aria-pressed`.",table:{category:"Behavior"}},pennants:{control:!1,description:"Pennant badges displayed at the top of the panel, anchored to the end edge. Up to 5 small-sized pennants fit on a panel of ~240px wide.",table:{category:"Slots"}},"action-icon":{control:!1,description:"Custom icon for the action overlay button. Receives `active` (current pressed state).",table:{category:"Slots"}}},args:{color:"blue",imageSrc:"https://picsum.photos/seed/coverpanel1/300/450",imageAlt:"Cover image",title:"Cover Panel Title",clickBehavior:"none","onImage-click":R(),"onAction-click":R()},parameters:{snapshot:{viewports:["sm","md","lg","xl"]}}},c=n=>({color:n.color,imageSrc:n.imageSrc,imageAlt:n.imageAlt,title:n.title,imageAriaLabel:n.imageAriaLabel,rounded:n.rounded}),A={tags:["snapshot"],parameters:{docs:{source:{code:`<NeoCoverPanel
  color="blue"
...
</template>`}}},args:{imageSrc:m,imageAlt:"Cover placeholder",clickBehavior:"action",imageAriaLabel:"Select this item",actionAriaLabel:"Add to favorites",actionActive:!1},render:n=>i({name:"ImageClickAndActionButtonRender",setup(){const a=I(!1),t=I(!1);return()=>e("div",{style:{display:"flex",gap:"24px",padding:"16px",alignItems:"flex-start"}},[e("div",{style:{inlineSize:"160px"}},[e(r,l(c(n),{clickBehavior:"action",imageAriaLabel:a.value?"Deselect this item":"Select this item",actionAriaLabel:t.value?"Remove from favorites":"Add to favorites",actionActive:t.value,"onImage-click":()=>{a.value=!a.value},"onAction-click":()=>{t.value=!t.value}}),{"action-icon":({active:L})=>L?d:v})]),e("div",{style:{display:"flex",flexDirection:"column",gap:"8px",fontSize:"14px",fontFamily:"sans-serif",paddingBlockStart:"8px"}},[e("div",null,[F("Image click:")," ",e("strong",{style:{color:a.value?"green":"inherit"}},[a.value?"selected":"idle"])]),e("div",null,[F("Action button:")," ",e("strong",{style:{color:t.value?"#e11d48":"inherit"}},[t.value?"favoured":"idle"])])])])}})},b={tags:["snapshot"],parameters:{docs:{source:{code:`<NeoCoverPanel
  color="blue"
  image-src="/path/to/cover.jpg"
  image-alt="Cover placeholder"
  click-behavior="link"
...
</template>`}}},args:{imageSrc:m,imageAlt:"Cover placeholder",actionAriaLabel:"42 votes"},render:n=>i({name:"WithActionCountRender",setup(){const a=I(42),t=I(!1),L=()=>{t.value=!t.value,a.value=t.value?a.value+1:a.value-1};return()=>e("div",{style:{inlineSize:"160px",padding:"16px"}},[e(r,l(c(n),{clickBehavior:"none",actionAriaLabel:`${a.value} votes`,actionActive:t.value,"onAction-click":L}),{"action-icon":({active:w})=>e("span",{style:{alignItems:"center",color:w?"white":"var(--neo-theme-color)",display:"inline-flex",fontSize:"11px",fontWeight:"700",gap:"2px"}},[w?d:v,a.value])})])}})},k={tags:["snapshot"],globals:{direction:"rtl"},parameters:{snapshot:{viewports:["sm","xl"]}},args:{title:"عنوان لوحة الغلاف"}},h={tags:["snapshot"],parameters:{snapshot:{viewports:["sm","xl"]}},render:n=>i({name:"AllColorsRender",setup(){return()=>e("div",{style:{display:"flex",flexWrap:"wrap",gap:"12px",padding:"16px"}},[be.map(a=>e("div",{key:a,style:{inlineSize:"120px"}},[e(r,l(c(n),{color:a,imageSrc:B(300,450),imageAlt:`Cover placeholder for ${a}`,clickBehavior:"none",actionAriaLabel:"Add to favorites"}),{"action-icon":({active:t})=>t?d:v})]))])}})},f={tags:["snapshot"],globals:{backgrounds:"#000"},parameters:{snapshot:{viewports:["sm","xl"]}},render:n=>i({name:"AllColorsOnDarkRender",setup(){return()=>e("div",{class:"u-onDark",style:{display:"flex",flexWrap:"wrap",gap:"12px",padding:"16px"}},[be.map(a=>e("div",{key:a,style:{inlineSize:"120px"}},[e(r,l(c(n),{color:a,imageSrc:B(300,450),imageAlt:`Cover placeholder for ${a}`,clickBehavior:"none",actionAriaLabel:"Add to favorites"}),{"action-icon":({active:t})=>t?d:v})]))])}})},S={...h,tags:["!dev","test-only"],play:Pe()},x={...f,tags:["!dev","test-only"],play:Pe()};var H,z,D;A.parameters={...A.parameters,docs:{...(H=A.parameters)==null?void 0:H.docs,source:{originalSource:`{
  tags: ['snapshot'],
  parameters: {
    docs: {
      source: {
...
}`,...(O=(j=u.parameters)==null?void 0:j.docs)==null?void 0:O.source},description:{story:'The image surface itself is a `<button>` (clickBehavior="action").\nClicking it emits `image-click` — useful for selection, expanding a modal, etc.\nThe floating action button (heart) emits `action-click` independently.\nBoth are demonstrated here with separate visible state.',...(T=($=u.parameters)==null?void 0:$.docs)==null?void 0:T.description}}};var M,_,V;b.parameters={...b.parameters,docs:{...(M=b.parameters)==null?void 0:M.docs,source:{originalSource:`{
  tags: ['snapshot'],
  parameters: {
    docs: {
      source: {
...
}`,...(V=(_=b.parameters)==null?void 0:_.docs)==null?void 0:V.source}}};var U,E,K;C.parameters={...C.parameters,docs:{...(U=C.parameters)==null?void 0:U.docs,source:{originalSource:`{
  tags: ['snapshot'],
  parameters: {
    docs: {
      source: {
...
}`,...(K=(E=C.parameters)==null?void 0:E.docs)==null?void 0:K.source}}};var Y,q,G,J,Q;g.parameters={...g.parameters,docs:{...(Y=g.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  tags: ['no-test'],
  parameters: {
    docs: {
      source: {
