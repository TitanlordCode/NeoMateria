import{d as w,f as A,Q as vo,x as m,y as p,v as T,A as C,F as ne,P as se,B as k,u as d,a as Z,z as re,Z as ko,L as fo,t as No,w as Ro,N as To,c as l,m as b,r as V,i as Co}from"./iframe-D9nyRK5o.js";import{g as le,_ as So}from"./_plugin-vue_export-helper-DerOYOQE.js";import{N as xo}from"./NeoBadge-DOaopeSJ.js";import{N as Bo}from"./NeoProgressBar-whdCtl-A.js";import{_ as Ao}from"./NeoIconButton-DtDeCrqL.js";import{D as ae}from"./defaultIcons-DXzthn_L.js";import{N as Ho}from"./NeoButton-CODeixOj.js";import"./preload-helper-Dp1pzeXC.js";import"./NeoIcon-Cexy51PO.js";import"./iconStrings-DvlgHS7z.js";import"./useButton-B-Bpk_ne.js";const Do=["role"],Lo={key:0,class:"NeoTable-caption"},Io=["role"],zo=["role"],_o=["role","onClick","onKeydown"],Wo={class:"NeoTable-header-content"},$o=["role"],qo=["role"],Po=["tabindex","role","onClick","onKeydown"],Eo=["role"],jo={key:0},Mo=["colspan"],G=w({__name:"NeoTable",props:{columns:{},rows:{},caption:{},color:{default:"grey"},size:{default:"default"},striped:{type:Boolean,default:!1},hoverable:{type:Boolean,default:!0},stickyHeader:{type:Boolean,default:!1},rowHref:{},sortBy:{},sortDirection:{},highlightRow:{},mobileLayout:{default:"scroll"},headerAxis:{default:"column"}},emits:["sort-change","row-click"],setup(n,{emit:a}){const e=n,i=a,N=A(()=>`NeoTable-wrapper NeoTable-wrapper--${e.mobileLayout==="cards"?"cards":"scroll"}`),J=A(()=>{const o=le({component:"NeoTable",modifiers:[e.size??"default",e.stickyHeader?"stickyHeader":""]}),t=le({component:"Themed",modifiers:[e.color??"grey"]});return`${o} ${t}`}),y=vo(),h=A(()=>!!y["row-action"]),X=A(()=>e.columns.length+(h.value?1:0)),ee=o=>["NeoTable-header",`NeoTable-header--align-${o.align??"start"}`,o.sortable?"NeoTable-header--sortable":""].filter(Boolean).join(" "),v=o=>e.headerAxis==="row"&&o===0,oe=(o,t)=>["NeoTable-cell",v(t)?"NeoTable-row-header":"",`NeoTable-cell--align-${o.align??"start"}`,o.truncate?"NeoTable-cell--truncate":""].filter(Boolean).join(" "),go=(o,t)=>{var s;return["NeoTable-row",e.hoverable?"NeoTable-row--hoverable":"",e.striped&&t%2===1?"NeoTable-row--striped":"",(s=e.highlightRow)!=null&&s.call(e,o)?"NeoTable-row--highlighted":"",x(o)?"NeoTable-row--clickable":""].filter(Boolean).join(" ")},yo=o=>e.sortBy!==o?"NeoTable-sort-icon NeoTable-sort-icon--inactive":`NeoTable-sort-icon NeoTable-sort-icon--${e.sortDirection??"asc"}`,x=o=>!!e.rowHref&&typeof o[e.rowHref]=="string",te=o=>{const t=e.sortBy===o&&e.sortDirection==="asc"?"desc":"asc";i("sort-change",o,t)},bo=(o,t)=>{if(x(o)){const s=o[e.rowHref];t.ctrlKey||t.metaKey?window.open(s,"_blank"):window.location.href=s}e.hoverable&&i("row-click",o)},ho=(o,t)=>{x(t)&&(o.key==="Enter"||o.key===" ")&&(o.preventDefault(),window.location.href=t[e.rowHref])};return(o,t)=>(d(),m("div",{class:k(N.value)},[p("table",{class:k(J.value),role:e.mobileLayout==="cards"?"table":void 0},[e.caption||o.$slots.caption?(d(),m("caption",Lo,[T(o.$slots,"caption",{},()=>[Z(re(e.caption),1)],!0)])):C("",!0),p("thead",{class:"NeoTable-head",role:e.mobileLayout==="cards"?"rowgroup":void 0},[p("tr",{role:e.mobileLayout==="cards"?"row":void 0},[(d(!0),m(ne,null,se(e.columns,s=>(d(),m("th",{key:s.key,scope:"col",class:k(ee(s)),style:fo(s.width?{width:s.width}:void 0),role:e.mobileLayout==="cards"?"columnheader":void 0,onClick:R=>s.sortable&&te(s.key),onKeydown:ko(R=>s.sortable&&te(s.key),["enter"])},[T(o.$slots,`header:${s.key}`,{column:s},()=>[p("span",Wo,[p("span",null,re(s.label),1),s.sortable?(d(),m("span",{key:0,class:k(yo(s.key)),"aria-hidden":"true"},[...t[0]||(t[0]=[p("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2.5","stroke-linecap":"round","stroke-linejoin":"round"},[p("polyline",{points:"6 9 12 15 18 9"})],-1)])],2)):C("",!0)])],!0)],46,_o))),128)),o.$slots["row-action"]?(d(),m("th",{key:0,scope:"col",class:"NeoTable-header NeoTable-header--action",role:e.mobileLayout==="cards"?"columnheader":void 0},[...t[1]||(t[1]=[p("span",{class:"sr-only"},"Actions",-1)])],8,$o)):C("",!0)],8,zo)],8,Io),p("tbody",{role:e.mobileLayout==="cards"?"rowgroup":void 0},[(d(!0),m(ne,null,se(e.rows,(s,R)=>(d(),m("tr",{key:R,class:k(go(s,R)),tabindex:x(s)?0:void 0,role:e.mobileLayout==="cards"?"row":void 0,onClick:u=>bo(s,u),onKeydown:u=>ho(u,s)},[(d(!0),m(ne,null,se(e.columns,(u,B)=>(d(),No(To(v(B)?"th":"td"),{key:u.key,scope:v(B)?"row":void 0,class:k(oe(u,B)),"data-label":u.label,role:e.mobileLayout==="cards"?v(B)?"rowheader":"cell":void 0},{default:Ro(()=>[T(o.$slots,`cell:${u.key}`,{row:s,value:s[u.key],column:u,index:R},()=>[Z(re(s[u.key]),1)],!0)]),_:2},1032,["scope","class","data-label","role"]))),128)),o.$slots["row-action"]?(d(),m("td",{key:0,class:"NeoTable-cell NeoTable-cell--action",role:e.mobileLayout==="cards"?"cell":void 0},[T(o.$slots,"row-action",{row:s},void 0,!0)],8,Eo)):C("",!0)],42,Po))),128)),e.rows.length===0?(d(),m("tr",jo,[p("td",{colspan:X.value,class:"NeoTable-empty-cell"},[T(o.$slots,"empty",{},()=>[t[2]||(t[2]=p("span",{class:"NeoTable-empty-message"},"No data available",-1))],!0)],8,Mo)])):C("",!0)],8,qo)],10,Do)],2))}}),g=So(G,[["__scopeId","data-v-6ff3a538"]]);G.__docgenInfo=Object.assign({displayName:G.name??G.__name},{exportName:"default",displayName:"NeoTable",type:1,props:[{name:"columns",global:!1,description:"",tags:[],required:!0,type:"NeoTableColumn[]",declarations:[],schema:{kind:"array",type:"NeoTableColumn[]"}},{name:"rows",global:!1,description:"",tags:[],required:!0,type:"Record<string, unknown>[]",declarations:[],schema:{kind:"array",type:"Record<string, unknown>[]"}},{name:"caption",global:!1,description:"",tags:[],required:!1,type:"string",declarations:[],schema:"string"},{name:"color",global:!1,description:"",tags:[],required:!1,type:"SurfaceColor",declarations:[],schema:{kind:"array",type:"SurfaceColor"},default:'"grey"'},{name:"size",global:!1,description:"",tags:[],required:!1,type:'"default" | "compact" | "spacious"',declarations:[],schema:{kind:"enum",type:'"default" | "compact" | "spacious"',schema:['"default"','"compact"','"spacious"']},default:'"default"'},{name:"striped",global:!1,description:"",tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]},default:"false"},{name:"hoverable",global:!1,description:"",tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]},default:"true"},{name:"stickyHeader",global:!1,description:"",tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]},default:"false"},{name:"rowHref",global:!1,description:"",tags:[],required:!1,type:"string",declarations:[],schema:"string"},{name:"sortBy",global:!1,description:"",tags:[],required:!1,type:"string",declarations:[],schema:"string"},{name:"sortDirection",global:!1,description:"",tags:[],required:!1,type:'"asc" | "desc"',declarations:[],schema:{kind:"enum",type:'"asc" | "desc"',schema:['"asc"','"desc"']}},{name:"highlightRow",global:!1,description:"",tags:[],required:!1,type:"(row: Record<string, unknown>) => boolean",declarations:[],schema:{kind:"event",type:"(row: Record<string, unknown>): boolean"}},{name:"mobileLayout",global:!1,description:"",tags:[],required:!1,type:'"scroll" | "cards"',declarations:[],schema:{kind:"enum",type:'"scroll" | "cards"',schema:['"scroll"','"cards"']},default:'"scroll"'},{name:"headerAxis",global:!1,description:"",tags:[],required:!1,type:'"column" | "row"',declarations:[],schema:{kind:"enum",type:'"column" | "row"',schema:['"column"','"row"']},default:'"column"'},{name:"key",global:!0,description:"",tags:[],required:!1,type:"PropertyKey",declarations:[],schema:{kind:"enum",type:"PropertyKey",schema:["string","number","symbol"]}},{name:"ref",global:!0,description:"",tags:[],required:!1,type:"VNodeRef",declarations:[],schema:{kind:"enum",type:"VNodeRef",schema:["string","Ref<any, any>",{kind:"event",type:"(ref: Element | ComponentPublicInstance<{}, {}, {}, {}, {}, {}, {}, {}, false, ComponentOptionsBase<any, any, any, any, any, any, any, any, any, {}, {}, string, {}, {}, {}, string, ComponentProvideOptions>, ... 4 more ..., any>, refs: Record<...>): void"}]}},{name:"ref_for",global:!0,description:"",tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"ref_key",global:!0,description:"",tags:[],required:!1,type:"string",declarations:[],schema:"string"},{name:"class",global:!0,description:"",tags:[],required:!1,type:"unknown",declarations:[],schema:"unknown"},{name:"style",global:!0,description:"",tags:[],required:!1,type:"unknown",declarations:[],schema:"unknown"}],events:[{name:"sort-change",description:"Emitted when a sortable header is clicked.",tags:[],type:'[key: string, direction: "asc" | "desc"]',signature:'(event: "sort-change", key: string, direction: "asc" | "desc"): void',declarations:[],schema:["string",{kind:"enum",type:'"asc" | "desc"',schema:['"asc"','"desc"']}]},{name:"row-click",description:"Emitted when a hoverable row is clicked.",tags:[],type:"[row: Record<string, unknown>]",signature:'(event: "row-click", row: Record<string, unknown>): void',declarations:[],schema:["Record<string, unknown>"]}],slots:[{name:"caption",type:"{}",description:"",declarations:[],schema:{kind:"object",type:"{}"}},{name:"row-action",type:"{ row: Record<string, unknown>; }",description:"",declarations:[],schema:{kind:"object",type:"{ row: Record<string, unknown>; }"}},{name:"empty",type:"{}",description:"",declarations:[],schema:{kind:"object",type:"{}"}}],exposed:[{name:"$slots",type:"Readonly<InternalSlots> & { [x: `header:${string}`]: (props: { column: NeoTableColumn; }) => any; } & { [x: `cell:${string}`]: (props: { row: Record<string, unknown>; value: unknown; column: NeoTableColumn; index: number; }) => any; } & { ...; } & { ...; } & { ...; }",description:"",declarations:[],schema:{kind:"object",type:"Readonly<InternalSlots> & { [x: `header:${string}`]: (props: { column: NeoTableColumn; }) => any; } & { [x: `cell:${string}`]: (props: { row: Record<string, unknown>; value: unknown; column: NeoTableColumn; index: number; }) => any; } & { ...; } & { ...; } & { ...; }"}},{name:"color",type:"any",description:"",declarations:[],schema:"any"},{name:"size",type:'"default" | "compact" | "spacious"',description:"",declarations:[],schema:{kind:"enum",type:'"default" | "compact" | "spacious"',schema:['"default"','"compact"','"spacious"']}},{name:"striped",type:"boolean",description:"",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"hoverable",type:"boolean",description:"",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"stickyHeader",type:"boolean",description:"",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"mobileLayout",type:'"scroll" | "cards"',description:"",declarations:[],schema:{kind:"enum",type:'"scroll" | "cards"',schema:['"scroll"','"cards"']}},{name:"headerAxis",type:'"column" | "row"',description:"",declarations:[],schema:{kind:"enum",type:'"column" | "row"',schema:['"column"','"row"']}},{name:"caption",type:"string",description:"",declarations:[],schema:"string"},{name:"rows",type:"Record<string, unknown>[]",description:"",declarations:[],schema:{kind:"array",type:"Record<string, unknown>[]"}},{name:"columns",type:"NeoTableColumn[]",description:"",declarations:[],schema:{kind:"array",type:"NeoTableColumn[]"}},{name:"rowHref",type:"string",description:"",declarations:[],schema:"string"},{name:"sortBy",type:"string",description:"",declarations:[],schema:"string"},{name:"sortDirection",type:'"asc" | "desc"',description:"",declarations:[],schema:{kind:"enum",type:'"asc" | "desc"',schema:['"asc"','"desc"']}},{name:"highlightRow",type:"(row: Record<string, unknown>) => boolean",description:"",declarations:[],schema:{kind:"event",type:"(row: Record<string, unknown>): boolean"}}],sourceFiles:"/home/runner/work/NeoMateria/NeoMateria/src/components/02-molecules/Table/NeoTable.vue"});const Uo=["compact","default","spacious"],Fo=["column","row"],{expect:f,userEvent:ce,waitFor:ie,within:Ko}=__STORYBOOK_MODULE_TEST__;function Oo(n){return typeof n=="function"||Object.prototype.toString.call(n)==="[object Object]"&&!Co(n)}const an={title:"Molecules/NeoTable",component:g,tags:["autodocs","grimeria"],argTypes:{size:{control:"select",options:Uo,description:"Controls cell padding and font size.",table:{category:"Appearance"}},color:{control:"select",description:"Accent color used for the table header and highlighted rows.",table:{category:"Appearance"}},striped:{control:"boolean",description:"Alternating row backgrounds for easier horizontal scanning.",table:{category:"Appearance"}},hoverable:{control:"boolean",description:"Highlight the row under the pointer and emit `row-click` on click.",table:{category:"Behavior"}},stickyHeader:{control:"boolean",description:"Freeze the header row so it stays visible when the table scrolls vertically.",table:{category:"Behavior"}},mobileLayout:{control:"select",options:["scroll","cards"],description:"`scroll`: the table scrolls horizontally on narrow viewports. `cards`: rows become labeled cards below the `bp-md` breakpoint.",table:{category:"Behavior"}},rowHref:{control:!1,description:"Key in the row data whose value is the URL. When set, matching rows become keyboard-accessible links.",table:{category:"Behavior"}},sortBy:{control:!1,description:"Controlled sort column key.",table:{category:"Sorting"}},sortDirection:{control:"select",options:["asc","desc"],description:"Controlled sort direction.",table:{category:"Sorting"}},highlightRow:{control:!1,description:"Predicate `(row) => boolean`. Rows that return true receive an accent background.",table:{category:"Appearance"}},headerAxis:{control:"select",options:Fo,description:'`column` (default): first row is the column header. `row`: first column of each data row becomes `<th scope="row">` — use when rows represent named entities (countries, products, people).',table:{category:"Behavior"}},columns:{control:!1,description:"Column definitions. Each: `{ key, label, sortable?, align?, ... }`.",table:{category:"Content"}},rows:{control:!1,description:"Array of row data objects, keyed by column `key`.",table:{category:"Content"}},caption:{control:"text",description:"Accessible table caption describing the data.",table:{category:"Content"}}},args:{color:"blue",size:"default",striped:!1,hoverable:!0,stickyHeader:!1,mobileLayout:"scroll",headerAxis:"column"},parameters:{snapshot:{viewports:["sm","md","lg","xl"]}}},c=[{key:"name",label:"Name",sortable:!0},{key:"role",label:"Role"},{key:"department",label:"Department",sortable:!0},{key:"status",label:"Status"},{key:"joinedYear",label:"Year",align:"end",sortable:!0}],r=[{name:"Alice Müller",role:"Lead Designer",department:"Product",status:"Active",progress:90,joinedYear:2019,profileUrl:"#"},{name:"Ben Nakamura",role:"Frontend Dev",department:"Engineering",status:"Active",progress:72,joinedYear:2021,profileUrl:"#"},{name:"Clara Santos",role:"Data Analyst",department:"Analytics",status:"Away",progress:55,joinedYear:2022,profileUrl:"#"},{name:"David Kim",role:"Product Manager",department:"Product",status:"Active",progress:88,joinedYear:2020,profileUrl:"#"},{name:"Eva Larsson",role:"QA Engineer",department:"Engineering",status:"Inactive",progress:30,joinedYear:2023,profileUrl:"#"}],Yo={Active:"green",Away:"amber",Inactive:"red"},H={tags:["snapshot"],args:{columns:c,rows:r},parameters:{docs:{source:{code:'<NeoTable :columns="columns" :rows="rows" color="blue" />'}}}},D={tags:["snapshot"],args:{columns:c,rows:r,striped:!0},parameters:{docs:{source:{code:'<NeoTable :columns="columns" :rows="rows" :striped="true" color="blue" />'}}}},L={tags:["snapshot"],args:{columns:c,rows:r,size:"compact"},parameters:{docs:{source:{code:'<NeoTable :columns="columns" :rows="rows" size="compact" color="blue" />'}}}},I={tags:["snapshot"],args:{columns:c,rows:r,size:"spacious"},parameters:{docs:{source:{code:'<NeoTable :columns="columns" :rows="rows" size="spacious" color="blue" />'}}}},z={tags:["snapshot"],args:{columns:c,rows:r},parameters:{docs:{source:{code:`<script setup>
...
<template>
  ...
  />
</template>`}}},render:n=>w({name:"WithSortingRender",setup(){const a=V(""),e=V("asc"),i=V([...r]),N=(y,h)=>{i.value=[...r].sort((X,ee)=>{const v=String(X[y]),oe=String(ee[y]);return v.localeCompare(oe)*(h==="asc"?1:-1)})},J=(y,h)=>{a.value=y,e.value=h,N(y,h)};return()=>l(g,b(n,{columns:c,rows:i.value,sortBy:a.value,sortDirection:e.value,"onSort-change":J}),null)}}),play:async({canvasElement:n,step:a})=>{const e=Ko(n);await a("Click Name header to sort ascending",async()=>{await ce.click(e.getByText("Name")),await ie(()=>{const i=e.getByText("Name").closest("th");f(i==null?void 0:i.querySelector(".NeoTable-sort-icon--asc")).not.toBeNull()})}),await a("Click Name header again to sort descending",async()=>{await ce.click(e.getByText("Name")),await ie(()=>{const i=e.getByText("Name").closest("th");f(i==null?void 0:i.querySelector(".NeoTable-sort-icon--desc")).not.toBeNull()})})}},_={tags:["snapshot"],args:{columns:c,rows:r,highlightRow:n=>n.status==="Active",color:"green"},parameters:{docs:{source:{code:`<NeoTable
  :columns="columns"
  :rows="rows"
...
</NeoTable>`}}},render:n=>w({name:"WithSlotsRender",setup(){const a=[{key:"name",label:"Name",sortable:!0},{key:"role",label:"Role"},{key:"status",label:"Status"},{key:"progress",label:"Progress",align:"start"}];return()=>l(g,b(n,{columns:a,rows:r}),{"cell:status":({value:e})=>l(xo,{color:Yo[String(e)]??"grey",text:String(e),variant:"solid",size:"small"},null),"cell:progress":({value:e})=>l("div",{style:{alignItems:"center",display:"flex",gap:"8px",minInlineSize:"120px"}},[l(Bo,{value:Number(e),ariaLabel:`${Number(e)}% complete`,color:"blue",size:"small"},null),l("span",{style:{color:"var(--neo-color-grey600)",fontSize:"13px",flexShrink:0}},[Number(e),Z("%")])])})}})},$={tags:["snapshot"],args:{columns:c,rows:r,rowHref:"profileUrl",color:"blue"},parameters:{docs:{source:{code:`<!-- rowHref points to the key in row data that holds the destination URL.
...
</NeoTable>`}}},render:n=>w({name:"WithEmptyStateRender",setup(){return()=>l(g,b(n,{columns:c,rows:[]}),{empty:()=>l("div",{style:{alignItems:"center",display:"flex",flexDirection:"column",gap:"8px",padding:"24px 0"}},[l("p",null,[Z("No team members found.")]),l(Ho,{color:"blue",variant:"secondary",text:"Add member"},null)])})}})},E={tags:["no-test"],args:{columns:c,rows:[...r,...r.map(n=>({...n,name:n.name+" II"})),...r.map(n=>({...n,name:n.name+" III"}))],stickyHeader:!0},parameters:{docs:{source:{code:`<!-- Wrap in a height-constrained container to see the sticky header in action -->
<div style="max-block-size: 280px; overflow-y: auto;">
  <NeoTable :columns="columns" :rows="rows" :sticky-header="true" color="blue" />
</div>`}}},render:n=>w({name:"WithStickyHeaderRender",setup(){const a=[...r,...r.map(e=>({...e,name:e.name+" II"})),...r.map(e=>({...e,name:e.name+" III"}))];return()=>l("div",{style:{blockSize:"280px",overflowY:"auto"}},[l(g,b(n,{columns:c,rows:a,stickyHeader:!0}),null)])}})},j={tags:["snapshot"],args:{columns:c,rows:r,mobileLayout:"cards"},parameters:{snapshot:{viewports:["sm"]},docs:{source:{code:`<!-- mobileLayout="cards" transforms rows into labelled cards below bp-md.
...
<NeoTable
  ...
  mobile-layout="cards"
  color="blue"
/>`}}}},M={tags:["snapshot"],args:{columns:c,rows:r,caption:"Team members by department"},parameters:{docs:{source:{code:`<NeoTable
  :columns="columns"
  :rows="rows"
...
<NeoTable
  ...
  header-axis="row"
  color="blue"
/>`}}},play:async({canvasElement:n,step:a})=>{await a('First body column cells are <th scope="row">',async()=>{const e=n.querySelectorAll('tbody th[scope="row"]');f(e).toHaveLength(S.length)}),await a("Remaining body cells are <td>",async()=>{const e=n.querySelectorAll("tbody td");f(e).toHaveLength(S.length*(Q.length-1))}),await a('Column headers remain in thead with scope="col"',async()=>{const e=n.querySelectorAll('thead th[scope="col"]');f(e).toHaveLength(Q.length)}),await a("Row header cells have NeoTable-row-header class",async()=>{const e=n.querySelectorAll("tbody .NeoTable-row-header");f(e).toHaveLength(S.length)})}},K={tags:["snapshot"],args:{columns:Q,rows:S,headerAxis:"row",mobileLayout:"cards",color:"blue"},parameters:{snapshot:{viewports:["sm"]},docs:{source:{code:`<!-- In cards layout, the row-header cell renders as the card title
...
/>`}}}},de=[{key:"name",label:"الاسم",sortable:!0},{key:"role",label:"الدور"},{key:"department",label:"القسم"},{key:"status",label:"الحالة"}],ue=[{name:"فاطمة العلي",role:"مصممة رئيسية",department:"المنتج",status:"نشطة"},{name:"عمر الشريف",role:"مطور واجهات",department:"الهندسة",status:"نشط"},{name:"ليلى حسن",role:"محللة بيانات",department:"التحليلات",status:"غائبة"},{name:"كريم منصور",role:"مدير منتج",department:"المنتج",status:"نشط"},{name:"نور إبراهيم",role:"مهندسة جودة",department:"الهندسة",status:"غير نشطة"}],me=[{key:"country",label:"الدولة",width:"200px"},{key:"population",label:"السكان",align:"end"},{key:"gdp",label:"الناتج المحلي",align:"end"},{key:"growth",label:"النمو",align:"end"}],pe=[{country:"المملكة العربية السعودية",population:"٣٦.٤ م",gdp:"١.١ تريليون $",growth:"+٣.٠٪"},{country:"الإمارات العربية المتحدة",population:"٩.٩ م",gdp:"٥٠٧ مليار $",growth:"+٣.٤٪"},{country:"مصر",population:"١٠٤.٢ م",gdp:"٣٨٧ مليار $",growth:"+٣.٨٪"},{country:"العراق",population:"٤٢.٦ م",gdp:"٢٦٨ مليار $",growth:"+٤.٥٪"},{country:"الأردن",population:"١٠.٢ م",gdp:"٥٠ مليار $",growth:"+٢.٦٪"}],O={tags:["snapshot"],args:{columns:de,rows:ue},parameters:{snapshot:{viewports:["sm","xl"]},docs:{source:{code:`<div dir="rtl">
  <NeoTable :columns="columns" :rows="rows" color="blue" />
</div>`}}},render:n=>w({name:"RTLRender",setup(){return()=>l("div",{dir:"rtl"},[l(g,b(n,{columns:de,rows:ue,color:"blue"}),null)])}})},Y={tags:["snapshot"],args:{columns:me,rows:pe,headerAxis:"row"},parameters:{snapshot:{viewports:["sm","xl"]},docs:{source:{code:`<div dir="rtl">
  <NeoTable :columns="columns" :rows="rows" header-axis="row" color="blue" />
</div>`}}},render:n=>w({name:"RTLWithRowHeadersRender",setup(){return()=>l("div",{dir:"rtl"},[l(g,b(n,{columns:me,rows:pe,headerAxis:"row",color:"blue"}),null)])}})};var we,ge,ye;H.parameters={...H.parameters,docs:{...(we=H.parameters)==null?void 0:we.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
...
}`,...(Ee=(Pe=q.parameters)==null?void 0:Pe.docs)==null?void 0:Ee.source}}};var je,Me,Ue;P.parameters={...P.parameters,docs:{...(je=P.parameters)==null?void 0:je.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
    columns: sampleColumns,
    rows: []
...
}`,...(Ue=(Me=P.parameters)==null?void 0:Me.docs)==null?void 0:Ue.source}}};var Fe,Ke,Oe;E.parameters={...E.parameters,docs:{...(Fe=E.parameters)==null?void 0:Fe.docs,source:{originalSource:`{
  tags: ['no-test'],
  args: {
    columns: sampleColumns,
...
}`,...(Oe=(Ke=E.parameters)==null?void 0:Ke.docs)==null?void 0:Oe.source}}};var Ye,Ve,Ge;j.parameters={...j.parameters,docs:{...(Ye=j.parameters)==null?void 0:Ye.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
    columns: sampleColumns,
    rows: sampleRows as unknown as Record<string, unknown>[],
...
}`,...(Ge=(Ve=j.parameters)==null?void 0:Ve.docs)==null?void 0:Ge.source}}};var Qe,Ze,Je;M.parameters={...M.parameters,docs:{...(Qe=M.parameters)==null?void 0:Qe.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
    columns: sampleColumns,
    rows: sampleRows as unknown as Record<string, unknown>[],
...
}`,...(Je=(Ze=M.parameters)==null?void 0:Ze.docs)==null?void 0:Je.source}}};var Xe,eo,oo;U.parameters={...U.parameters,docs:{...(Xe=U.parameters)==null?void 0:Xe.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
    columns: sampleColumns,
    rows: sampleRows as unknown as Record<string, unknown>[],
...
}`,...(oo=(eo=U.parameters)==null?void 0:eo.docs)==null?void 0:oo.source}}};var no,so,ro;F.parameters={...F.parameters,docs:{...(no=F.parameters)==null?void 0:no.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
...
}`,...(ro=(so=F.parameters)==null?void 0:so.docs)==null?void 0:ro.source}}};var ao,to,lo;K.parameters={...K.parameters,docs:{...(ao=K.parameters)==null?void 0:ao.docs,source:{originalSource:`{
  tags: ['snapshot'],
  args: {
    columns: countryColumns,
    rows: countryRows,
...
}`,...(wo=(po=Y.parameters)==null?void 0:po.docs)==null?void 0:wo.source}}};const tn=["Default","Striped","Compact","Spacious","WithSorting","WithHighlighting","WithSlots","WithRowLinks","WithRowAction","WithEmptyState","WithStickyHeader","MobileCards","WithCaption","OnDark","WithRowHeaders","WithRowHeadersCards","RTL","RTLWithRowHeaders"];export{L as Compact,H as Default,j as MobileCards,U as OnDark,O as RTL,Y as RTLWithRowHeaders,I as Spacious,D as Striped,M as WithCaption,P as WithEmptyState,_ as WithHighlighting,q as WithRowAction,F as WithRowHeaders,K as WithRowHeadersCards,$ as WithRowLinks,W as WithSlots,z as WithSorting,E as WithStickyHeader,tn as __namedExportsOrder,an as default};
